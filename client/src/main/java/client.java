...
public final class client extends GameShell {
    ...
    public static RendererToolkit toolkit;
    ...
    public static VarRelated1 localPlayerGameState;
    ...
    public static LinkedList field9136 = new LinkedList();
    ...
    public static SoftLruHashTable field9131 = new SoftLruHashTable(8);
    ...
    public static HashTable npcEntities = new HashTable(64);

    @ObfuscatedName("client.hp")
    public static ObjectNode[] npcs = new ObjectNode[1024];
    ...
    public static int[] npcSlots = new int[1024];

    @ObfuscatedName("client.hi")
    public static int extendedInfoNpcCount = 0;

    @ObfuscatedName("client.ip")
    public static int[] extendedInfoNpcSlots = new int[251];

    @ObfuscatedName("client.ir")
    public static int field8971 = 0;

    @ObfuscatedName("client.ie")
    public static int removedNpcCount = 0;

    @ObfuscatedName("client.ii")
    public static int[] removedNpcSlots = new int[1005];
    ...
    public static HashTable field9088 = new HashTable(64);

    @ObfuscatedName("client.oe")
    public static LinkedList field9007 = new LinkedList();

    @ObfuscatedName("client.ow")
    public static HashTable field9090 = new HashTable(16);
    ...
    public static HashTable field9075 = new HashTable(8);
    ...
    public static int[] varpTransmitted = new int[32];
    ...
    public static int[] varcTransmitted = new int[32];

    @ObfuscatedName("client.rk")
    public static int varcTransmitNum = 0;

    @ObfuscatedName("client.ry")
    public static int[] varcstrTransmitted = new int[32];
    ...
    public static LinkedList field9159 = new LinkedList();
    ...
    public final void init() {
            ...
            if (var5 != null) {
                switch (Integer.parseInt(var4.field3261)) {
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        modewhere = (ModeWhere) SerializableEnums.decode(ModeWhere.method11173(), Integer.parseInt(var5));
                        if (modewhere == ModeWhere.field6363) {
                            modewhere = ModeWhere.field6369;
                        } else if (!ModeWhere.method11177(modewhere) && modewhere != ModeWhere.LIVE) {
        ...
        GameShellFrameParameters var6 = new GameShellFrameParameters(frameWidth, frameHeight, field9129, field9066, modeGame.field6401);
        field1543 = this;
    ...
    public final void maininit() {
        ...
        options = Statics.method2808();
        if (options.field9667.method15884() == 1) {
            Scene.field4504 = false;
        }
        if (modewhere == ModeWhere.LIVE) {
            Statics.field6773.field6765 = Statics.field6387.getCodeBase().getHost();
        } else if (ModeWhere.method11177(modewhere)) {
            Statics.field6773.field6765 = Statics.field6387.getCodeBase().getHost();
        ...
        } else if (modewhere == ModeWhere.field6363) {
        ...
        WorldSwitcher.content = Statics.field6773;
        if (modeGame == ModeGame.RUNESCAPE) {
            field8940 = false;
        }
        Statics.field2744 = LocType.field6530 = NPCType.field7209 = ObjType.field7118 = new short[256];
        try {
            Statics.field8726 = GameShell.getTopContainer().getToolkit().getSystemClipboard();
        } catch (Exception var6) {
        }
        Statics.keyboard = Statics.method11115(GameShell.canvas);
        Statics.mouse = Mouse.method8198(GameShell.canvas, true);
    ...
    public void mainloop_inner() {
        ...
        if (toolkit != null) {
            toolkit.method444((int) MonotonicTime.get());
        }
        field8950 = 0;
        field8953 = 0;
        ...
        if (isStateTitle(state) && !isStateRebuild(state)) {
            ...
            if (LoginManager.enterGameReply != -3 && LoginManager.enterGameReply != 2 && LoginManager.enterGameReply != 15) {
                if (state == 0) {
                    ...
                    LoginManager.field547 = LoginManager.enterGameReply;
        ...
        ObjIconFactory.method185(toolkit);
    ...
    public void method14317() {
        ...
        if (GameShell.fsFrame == null) {
            ...
            if (GameShell.frameWid != var5 || GameShell.frameHei != var6 || field9165) {
                if (toolkit == null || toolkit.method448()) {
                    method13896();
                } else {
                    GameShell.frameWid = var5;
                    GameShell.frameHei = var6;
                }
                windowModeChangeTime = MonotonicTime.get() + 500L;
                field9165 = false;
            }
        }
        if (Fullscreen.allowed && GameShell.fsFrame != null && !Statics.field578 && method6478(state)) {
        ...
        if (toolkit != null && toolkit.method447() || getWindowMode() != 1) {
            method1703();
        }
        if (isStateLoading(state)) {
            ...
            if (world.method6087() == RebuildStage.field3775) {
                ...
                Statics.method2579(LocalisedText.field6938.get(Statics.language) + TextUtil.field492 + "(" + var9 + "%)", true, toolkit, Statics.field560, Statics.field9813);
            } else if (world.method6087() == RebuildStage.field3776) {
                int var10 = world.method6224() / 2 + 50;
                Statics.method2579(LocalisedText.field6938.get(Statics.language) + TextUtil.field492 + "(" + var10 + "%)", true, toolkit, Statics.field560, Statics.field9813);
            } else {
                Statics.method2579(LocalisedText.field6938.get(Statics.language), true, toolkit, Statics.field560, Statics.field9813);
            }
        } else if (state == 1) {
            method8591(var1);
        } else if (state == 9) {
            Statics.method2579(LocalisedText.field6961.get(Statics.language) + TextUtil.field492 + LocalisedText.field7025.get(Statics.language), false, toolkit, Statics.field560, Statics.field9813);
        } else if (state == 0) {
            Statics.method2579(LocalisedText.field6999.get(Statics.language), false, toolkit, Statics.field560, Statics.field9813);
        }
        if (field8929 == 3) {
            for (int var11 = 0; var11 < field9000; var11++) {
                Rectangle var12 = field9167[var11];
                if (field9166[var11]) {
                    toolkit.drawRectangle(var12.x, var12.y, var12.width, var12.height, -65281);
                } else {
                    toolkit.drawRectangle(var12.x, var12.y, var12.width, var12.height, -16711936);
                }
            }
        }
        if (DeveloperConsole.method14925()) {
            DeveloperConsole.method12188(toolkit);
        }
        if (!isStateLoading(state) && !isStateRebuild(state) && topLevelInterface != -1) {
            try {
                toolkit.method509();
                toolkit.method466();
            } catch (RendererException var15) {
                JagException.method16252(var15.getMessage() + " " + this.method6701(), var15);
                switch (options.toolkit.getValue()) {
                    case 3:
        ...
        int var14 = options.cpuUsage.method15874();
        if (var14 == 0) {
        ...
        if (options.field9669.method15877() == 1 && state == 6 && topLevelInterface != -1) {
            options.method15448(options.field9669, 0);
            Preferences.save();
        }
    }
    ...
    public static final void method4010() {
        ...
        Browser.method3613(var0, false, options.toolkit.getValue() == 5, field8915, field9218);
    }
    ...
    public final void method6674() {
        ...
        if (Fullscreen.allowed && GameShell.fsFrame != null) {
            Fullscreen.method2431(GameShell.fsImpl, GameShell.fsFrame);
    ...
    public String method6701() {
        ...
        try {
            ...
            if (Statics.localPlayerEntity == null) {
                var1 = var1 + Statics.currentPlayerLevel + TextUtil.COMMA + Statics.currentPlayerLevel + TextUtil.COMMA + Statics.currentPlayerLevel + TextUtil.COMMA + " ";
            } else {
                var1 = var1 + Statics.currentPlayerLevel + TextUtil.COMMA + (var2.x + Statics.localPlayerEntity.routeWaypointX[0]) + TextUtil.COMMA + (var2.z + Statics.localPlayerEntity.routeWaypointZ[0]) + " ";
            }
            var1 = var1 + options.toolkit.getValue() + " ";
            var1 = var1 + options.antialiasingDefault.getValue() + " ";
            var1 = var1 + getWindowMode() + " " + GameShell.canvasWid + TextUtil.COMMA + GameShell.canvasHei + " ";
            var1 = var1 + options.lightDetail.getValue() + " ";
            var1 = var1 + options.sceneryShadows.getValue() + " ";
            var1 = var1 + options.waterDetail.getValue() + " ";
    ...
    public static void setState(int state) {
        ...
        if (state != 9 && Statics.field3529 != null) {
            Statics.field3529.closeGracefully();
            Statics.field3529 = null;
        }
        if (state == 6) {
            method12035(client.state == 14 || client.state == 8 || topLevelInterface != graphicsDefaults.field5162);
        }
        if (state == 15) {
            method1350(topLevelInterface != graphicsDefaults.lobby_interface);
        }
        if (state == 3 || state == 4) {
            if (!LoginManager.requestLobbyLogin()) {
                return;
            }
        } else if (state == 18 || state == 11 && client.state != 7) {
        ...
        boolean var1 = state == 10 || isStateTitle(state) || isStateLobby(state);
        boolean var2 = client.state == 10 || isStateTitle(client.state) || isStateLobby(client.state);
        if (var1 != var2) {
            if (var1) {
                AudioRenderer.field4202 = AudioRenderer.field4205;
                if (options.volumeLoginMusic.getValue() == 0) {
                    MidiPlayer.method3311(2);
                } else {
                    MidiPlayer.method11764(2, Statics.midiSongs, AudioRenderer.field4205, 0, options.volumeLoginMusic.getValue(), false);
                    AudioRenderer.method2572();
                }
                js5TcpClient.method5744(false);
            } else {
                MidiPlayer.method3311(2);
                js5TcpClient.method5744(true);
            }
        }
        if (isStateRebuild(state) || state == 9 || state == 0) {
            toolkit.method587();
        }
        client.state = state;
    }
    ...
    public void js5Error() {
        if (js5TcpClient.errorCount > field9215) {
            WorldSwitcher.content.method12026();
            field9164 = js5TcpClient.errorCount * 250 - 250;
            if (field9164 > 3000) {
                field9164 = 3000;
            }
            ...
            if (js5TcpClient.errorCount >= 4 && isStateLoading(state)) {
                if (js5TcpClient.js5State == 7 || js5TcpClient.js5State == 9) {
                    ...
                    this.error("js5proxy_" + field8962.trim());
                }
                state = 13;
                return;
            }
        }
        field9215 = js5TcpClient.errorCount;
        if (field9164 > 0) {
            field9164--;
            return;
        }
        try {
            ...
            if (js5ConnectState == 2) {
                if (js5Stream.hasAvailable(1)) {
                    ...
                    js5ConnectState++;
                } else if (MonotonicTime.get() - field4263 > 30000L) {
    ...
    public static void method12035(boolean arg0) {
        if (arg0) {
            ...
            for (SubInterface var1 = (SubInterface) field9075.head(); var1 != null; var1 = (SubInterface) field9075.next()) {
                if (!var1.isLinked()) {
                    var1 = (SubInterface) field9075.head();
                    if (var1 == null) {
                        break;
                    }
                }
            ...
            topLevelInterface = -1;
            field9075 = new HashTable(8);
            Statics.method4591();
            topLevelInterface = graphicsDefaults.field5162;
        ...
        if (Statics.cameraState == 3) {
            cameraX = cameraMoveToX << 9;
            cameraZ = cameraMoveToZ << 9;
        } else {
    ...
    public static void method1350(boolean arg0) {
        if (arg0) {
            ...
            field9075 = new HashTable(8);
            Statics.method4591();
            topLevelInterface = graphicsDefaults.lobby_interface;
            computeTopLevelInterfaceLayout(false);
            method1703();
            ScriptRunner.method11505(topLevelInterface, null);
        }
    ...
    public static void method4567(int arg0, String arg1, boolean arg2) {
        ...
        Statics.fontProvider.method4838();
        Statics.fontProvider.method4837(fontFactory);
        DefaultSprites.method2931(toolkit);
        DefaultSprites.method15812(toolkit, Statics.field7387);
    ...
    public static void method11054(int arg0, String arg1, boolean arg2) {
        if (arg0 == 0) {
            toolkit = RendererToolkit.create(0, GameShell.canvas, Statics.field8465, Statics.field2670, options.antialiasing.getValue() * 2);
            if (arg1 != null) {
                toolkit.ba(1, 0);
                FontMetrics var3 = FontMetrics.create(Statics.field8745, Statics.field552, 0);
                Font var4 = toolkit.createFont(var3, (PalettedSpriteData[]) SpriteDataProvider.get(Statics.field7387, Statics.field552, 0), true);
                method3536();
                Statics.method2579(arg1, true, toolkit, var4, var3);
            }
        } else {
            label230:
            {
                ...
                if (arg1 != null) {
                    var5 = RendererToolkit.create(0, GameShell.canvas, Statics.field8465, Statics.field2670, 0);
                    var5.ba(1, 0);
                ...
                try {
                    try {
                        toolkit = RendererToolkit.create(arg0, GameShell.canvas, Statics.field8465, Statics.field2670, options.antialiasing.getValue() * 2);
                        if (arg1 != null) {
                            var5.ba(1, 0);
                        ...
                        if (toolkit.method629()) {
                            ...
                            Heap var12;
                            if (var10) {
                                var12 = toolkit.method593(146800640);
                            } else {
                                var12 = toolkit.method593(104857600);
                            }
                            toolkit.method502(var12);
                        }
                        break label230;
                    ...
                    int var15 = options.toolkit.getValue();
                    if (var15 == 2) {
                        field8928 = true;
                    }
                    options.method15448(options.toolkit, 0);
        ...
        if (arg2) {
            options.method15449(options.toolkit, !arg2);
        }
        options.method15448(options.toolkit, arg0);
        if (!arg2) {
            options.method15449(options.toolkit, !arg2);
        }
        Statics.method7897();
        toolkit.method673(10000);
        toolkit.J(32);
        world.method6235();
        if (toolkit.method450()) {
            setBloom(options.bloom.getValue() == 1);
        }
        world.method6086();
        world.getEnvironmentManager().method8154();
    ...
    public static void method11395() {
        ...
        for (int var4 = 0; var4 < npcCount; var4++) {
            NpcEntity var5 = (NpcEntity) npcs[var4].value;
            if (var5 != null) {
    ...
    public static void method2867() {
        if (toolkit.method455()) {
            ...
            Statics.method5600(options.toolkit.getValue(), false);
        }
        method1703();
    }
    ...
    public static int method1380(int arg0, int arg1) {
        if (graphicsDefaults.field5156 == -1) {
            return 1;
        }
        if (arg0 != options.toolkit.getValue()) {
            method4567(arg0, LocalisedText.field6960.get(Statics.language), true);
            if (options.toolkit.getValue() != arg0) {
                return -1;
            }
        }
        try {
            Dimension var2 = GameShell.canvas.getSize();
            Statics.method2579(LocalisedText.field6960.get(Statics.language), true, toolkit, Statics.field560, Statics.field9813);
            ModelUnlit var3 = ModelUnlit.method2664(Statics.field4560, graphicsDefaults.field5156, 0);
            long var4 = MonotonicTime.get();
            toolkit.L();
            field8925.method5114(0.0F, 256.0F, 0.0F);
            toolkit.method524(field8925);
            Matrix4x4 var6 = toolkit.method781();
            ...
            toolkit.method784(var6);
            toolkit.IA(1.0F);
            toolkit.m(16777215, 0.5F, 0.5F, 20.0F, -50.0F, 30.0F);
    ...
    public static void method3588(int arg0, int arg1, int arg2, int arg3, boolean arg4) {
        ...
        if (Fullscreen.allowed && arg1 == 3 && GameShell.fsFrame == null) {
            GameShell.fsFrame = Fullscreen.method6036(GameShell.fsImpl, arg2, arg3, 0, 0);
            if (GameShell.fsFrame != null) {
        ...
        if (arg1 == 3 && (!Fullscreen.allowed || GameShell.fsFrame == null)) {
            method3588(arg0, options.maxScreenSize.getValue(), -1, -1, true);
            return;
        }
    ...
    public static void notifyWindowStatus() {
        ClientMessage var0 = ClientMessage.createMessage(ClientProt.WINDOW_STATUS, gameConnection.randomOut);
        var0.buf.p1(getWindowMode());
        var0.buf.p2(GameShell.canvasWid);
        var0.buf.p2(GameShell.canvasHei);
        var0.buf.p1(options.antialiasing.getValue());
        gameConnection.queue(var0);
    }

    @ObfuscatedName("zq.gn(B)V")
    public static void method13896() {
        client var0 = field1543;
        synchronized (field1543) {
            if (GameShell.fsFrame == null) {
    ...
    public static void method3538() {
        ...
        try {
            JavascriptFunction.field3144.method4763(new Object[]{var0, var1, getWindowMode(), options.maxScreensize.method15794()});
    ...
    public static void method4635() {
        int var0 = 0;
        if (options != null) {
            var0 = options.maxScreensize.method15794();
        }
        if (var0 == 2) {
    ...
    public static boolean setBloom(boolean arg0) {
        ...
        if (!arg0) {
            toolkit.method558();
        } else if (!toolkit.method539()) {
            arg0 = false;
        }
        if (arg0 == var1) {
            return false;
        } else {
            options.method15448(options.bloom, arg0 ? 1 : 0);
            Preferences.save();
            return true;
        }
    }
    ...
    public static void method13901() {
        int var0 = 0;
        if (options.lightDetail.getValue() == 1) {
            int var1 = var0 | 0x1;
            int var2 = var1 | 0x10;
            int var3 = var2 | 0x20;
            int var4 = var3 | 0x2;
        ...
        if (options.texturing.getValue() == 0) {
            var0 |= 0x40;
        }
        Component.resetModelCache(var0);
        world.getLocTypeList().method11473(var0);
        asyncRebuild.method6040().getLocTypeList().method11473(var0);
        objTypes.method12295(var0);
        npcTypes.method12557(var0);
        field4213.method11084(var0);
    ...
    public static final void method2923() {
        ...
        Statics.fontProvider.method4846(50);
    ...
    public static final void method5025(boolean arg0) {
        if (!arg0) {
            ...
            objTypes.method12296();
            Statics.field566.method11143();
            field4213.method11088();
            ...
            Statics.fontProvider.method4849();
    ...
    public final void updateTitleScreen() {
        if (state == 15 && !LoginManager.isInProgress() || state == 11 && LoginManager.enterGameReply == 42 || state == 3 && (LoginManager.enterLobbyReply == 49 || LoginManager.enterLobbyReply == 52) || state == 14) {
            ...
            if (state != 3 || LoginManager.enterLobbyReply != 49 && LoginManager.enterLobbyReply != 52) {
                        ...
                        if (var6 != 0 || var7 != 0) {
                            ...
                            if (var10 > 0) {
                                ...
                                for (int var11 = 0; var11 < var10; var11++) {
                                    ...
                                    var3.field8645[var11] = MoveSpeed.WALK.id;
                                }
        ...
        if ((state == 6 || state == 11 || state == 15 || state == 14) && (!LoginManager.isInProgress() || state == 11 && LoginManager.enterGameReply == 42 || state == 3 && (LoginManager.enterLobbyReply == 49 || LoginManager.enterLobbyReply == 52)) && !Statics.method8399()) {
            if (Statics.cameraState == 3) {
                applyCameraCutscene();
            } else {
                applyCameraMoveAlong();
                                ...
                                while (true) {
                                    ...
                                    do {
                                        ...
                                        if (var20 == null) {
                                            ...
                                            if (state == 15 && !LoginManager.isInProgress() || state == 11 && LoginManager.enterGameReply == 42 || state == 3 && (LoginManager.enterLobbyReply == 49 || LoginManager.enterLobbyReply == 52)) {
                                                MiniMenu.update();
                                            }
    ...
    public static final void updateGame() {
        ...
        for (int var0 = 0; var0 < 100 && readServerProt(gameConnection); var0++) {
        }
        if (state != 1) {
            return;
        }
        ...
        if (Statics.field3357 == null) {
            if (MonotonicTime.get() >= Statics.field3307) {
                Statics.field3357 = field9192.method8637(WorldSwitcher.content.field6765);
            }
        } else if (Statics.field3357.field5178 != -1) {
            ClientMessage var3 = ClientMessage.createMessage(ClientProt.PING_STATISTICS, gameConnection.randomOut);
            if (Statics.field5168 == null || !Statics.field5168.isValid()) {
                try {
            ...
            int var9 = -1;
            if (Statics.field5168 != null) {
                long var10 = Statics.field5168.getCollectionTime();
                if (field9106 != -1L) {
                    long var12 = var10 - field9106;
                    long var14 = var7 - field9124;
                    if (var14 != 0L) {
            ...
            var3.buf.p1(field4121);
            var3.buf.p1(var9);
            var3.buf.p2_alt2(Statics.field3357.field5178);
            gameConnection.queue(var3);
            Statics.field3357 = null;
            Statics.field3307 = var7 + 30000L;
        }
        ClientWatch.method2676();
        GraphicsPacketQueue.method4786();
        BasicMouseEvent var16 = (BasicMouseEvent) field9136.head();
        if (world.getScene() != null) {
            if (Statics.cameraState == 3) {
                applyCameraCutscene();
            } else if (Statics.cameraState == 1) {
                applyCameraMoveAlong();
            }
        }
        if (field9016) {
        ...
        if (CameraManager.method14782()) {
            ...
            try {
                if (Statics.cameraState != 2) {
                    Statics.cam2.method3691(CameraControlMode.field2203);
                    if (Statics.cam2.getPosition() == null) {
                        Statics.cam2.method3693(PositionMode.POINT, false);
                    }
                    if (Statics.cam2.getLookat() == null) {
                        Statics.cam2.method3692(LookatMode.POINT, false);
                    }
                    if (Statics.cam2.getPositionMode() != PositionMode.POINT) {
                        Statics.cam2.method3693(PositionMode.POINT, false);
                    }
                    Statics.cam2.setPositionMaxSpeed(Vector3.create(99999.0F, 99999.0F, 99999.0F));
                    Statics.cam2.setPositionAcceleration(Vector3.create(Float.POSITIVE_INFINITY, Float.POSITIVE_INFINITY, Float.POSITIVE_INFINITY));
                    PositionPoint var17 = (PositionPoint) Statics.cam2.getPosition();
                    CoordGrid var18 = world.getBase();
                    var17.method14091(CoordFine.method8611(Statics.currentPlayerLevel, cameraX + var18.x * 512, -cameraY, cameraZ + var18.z * 512));
                    if (Statics.cam2.getLookatMode() != LookatMode.POINT) {
                        Statics.cam2.method3692(LookatMode.POINT, false);
                    }
                    Statics.cam2.setLookatMaxSpeed(Vector3.create(99999.0F, 99999.0F, 99999.0F));
                    Statics.cam2.setLookatAcceleration(Vector3.create(Float.POSITIVE_INFINITY, Float.POSITIVE_INFINITY, Float.POSITIVE_INFINITY));
                    LookatPoint var19 = (LookatPoint) Statics.cam2.getLookat();
                    var19.method15915(Statics.localPlayerEntity.method3684());
                }
                Statics.cam2.method3727((float) (MonotonicTime.get() - Statics.field2633) / 1000.0F, world.method6101(Statics.currentPlayerLevel), world.method6157().field3697);
                Statics.field2633 = MonotonicTime.get();
        ...
        if (sceneState == 2) {
            updatePlayers();
            updateNpcs();
        } else if (Statics.field2190.field5132.test(var16, keyboardEvents, field8953, Statics.keyboard)) {
            CutsceneManager.method14961(false);
        } else {
            if (sceneState == 4 && CutsceneManager.method2467(cutsceneId)) {
                world.method6135(new RebuildRequest(RebuildType.field3839, null));
                sceneState = 3;
            }
            if (sceneState == 3 && state != 16) {
            ...
            if (sceneState == 0) {
                int var21 = loopCycle - field8906;
                if (field9029 < Statics.field6396.length) {
                    do {
                        CutsceneAction var22 = Statics.field6396[field9029];
                        if (var22.field1566 > var21) {
                            break;
                        }
                        var22.method2873();
                    } while (sceneState == 0 && ++field9029 < Statics.field6396.length);
                }
                if (sceneState == 0) {
                    for (int var23 = 0; var23 < Statics.entities.length; var23++) {
                        CutsceneEntity var24 = Statics.entities[var23];
                        if (var24.exists) {
                            PathingEntity var25 = var24.method2854();
                            updateEntity(var25, true);
                        }
                    }
                }
            }
        ...
        if (Statics.selectedArea != null) {
            selectedCycle++;
            if (selectedCycle >= 15) {
                requestRedrawComponent(Statics.selectedArea);
                Statics.selectedArea = null;
            }
        }
        field9119 = null;
        field9080 = false;
        ...
        interfaceUpdateNum++;
        if (minimapClicked) {
            ClientMessage var26 = ClientMessage.createMessage(ClientProt.CLICKWORLDMAP, gameConnection.randomOut);
            var26.buf.p4_alt1(Statics.field669 << 28 | Statics.field9405 << 14 | Statics.field6665);
            gameConnection.queue(var26);
        ...
        while (true) {
            ...
            Component var29;
            do {
                var27 = (HookRequest) field9159.method11560();
                if (var27 == null) {
                    while (true) {
                        HookRequest var30;
                        Component var31;
                        Component var32;
                        do {
                            var30 = (HookRequest) field9125.method11560();
                            if (var30 == null) {
                                while (true) {
                                    HookRequest var33;
                                    Component var34;
                                    Component var35;
                                    do {
                                        var33 = (HookRequest) hookRequests.method11560();
                                        if (var33 == null) {
                                            ...
                                            MiniMenu.update();
                                            if (userStaffModLevel > 0 && Statics.keyboard.isKeyHeld(82) && Statics.keyboard.isKeyHeld(81) && field9002 != 0) {
                                                int var36 = Statics.localPlayerEntity.level - field9002;
                                                if (var36 < 0) {
                                                    var36 = 0;
                                                } else if (var36 > 3) {
                                                    var36 = 3;
                                                ...
                                                Statics.method2617(var36, var37.x + Statics.localPlayerEntity.routeWaypointX[0], var37.z + Statics.localPlayerEntity.routeWaypointZ[0]);
                                            }
                                            for (int var38 = 0; var38 < 5; var38++) {
                                                int var10002 = field9110[var38]++;
                                            }
                                            if (field9156 && field9157 < MonotonicTime.get() - 60000L) {
                                                method831();
                                            }
                                            for (TimestampMessage var39 = (TimestampMessage) field8934.method11649(); var39 != null; var39 = (TimestampMessage) field8934.method11644()) {
                                                if ((long) var39.field9262 < MonotonicTime.get() / 1000L - 5L) {
                                                    if (var39.field9264 > 0) {
                                                        ChatHistory.addMessage(5, 0, "", "", "", var39.field9263 + LocalisedText.field6986.get(Statics.language));
                                                    }
                                                    if (var39.field9264 == 0) {
                                                        ChatHistory.addMessage(5, 0, "", "", "", var39.field9263 + LocalisedText.field6987.get(Statics.language));
                                                    }
                                                    var39.method6975();
                                                }
                                            }
                                            ...
                                            if (gameConnection.numConnections > 50) {
                                                ClientMessage var42 = ClientMessage.createMessage(ClientProt.NO_TIMEOUT, gameConnection.randomOut);
                                                gameConnection.queue(var42);
                                            }
                                            if (field8978) {
    ...
    public static final void updateInterfaces() {
        for (int var0 = localPlayerGameState.pollServerValue(true); var0 != -1; var0 = localPlayerGameState.pollServerValue(false)) {
            onVarPlayerChanged(var0);
            varpTransmitted[++varpTransmitNum - 1 & 0x1F] = var0;
        }
        for (DelayedStateChange var1 = DelayedStateChange.poll(); var1 != null; var1 = DelayedStateChange.poll()) {
            ...
            if (var2 == 1) {
                // varcs
                Statics.field6666[(int) var3] = var1.intArg1;
                field9156 |= Statics.field2210[(int) var3];
                varcTransmitted[++varcTransmitNum - 1 & 0x1F] = (int) var3;
            } else if (var2 == 2) {
                // varcstrs
                Statics.field3498[(int) var3] = var1.stringArg;
                varcstrTransmitted[++varcstrTransmitNum - 1 & 0x1F] = (int) var3;
            } else if (var2 == 3) {
                ...
                if (var6.textantimacro != (var1.intArg1 == 1)) {
                    var6.textantimacro = var1.intArg1 == 1;
                ...
                if (var7.modelkind != var8 || var7.model != var9 || var7.field1832 != var10) {
                    var7.modelkind = var8;
                    var7.model = var9;
                    var7.field1832 = var10;
                    var7.customisation = null;
                    requestRedrawComponent(var7);
                }
            } else if (var2 == 5) {
                Component var11 = Component.get((int) var3);
                if (var1.intArg1 != var11.modelanim) {
                    if (var1.intArg1 == -1) {
                        var11.modelAnimator = null;
                    } else {
                        if (var11.modelAnimator == null) {
                            var11.modelAnimator = new InterfaceAnimationNode();
                        }
                        var11.modelAnimator.method11769(var1.intArg1);
                    }
                    var11.modelanim = var1.intArg1;
                    requestRedrawComponent(var11);
                }
            } else if (var2 == 6) {
                int var12 = var1.intArg1;
                ...
                if (var1.intArg1 != var20.modelangle_x || var1.intArg2 != var20.modelangle_y || var1.intArg3 != var20.modelzoom) {
                    var20.modelangle_x = var1.intArg1;
                    var20.modelangle_y = var1.intArg2;
                    var20.modelzoom = var1.intArg3;
                    if (var20.invobject != -1) {
                        if (var20.modelobjwidth > 0) {
                            var20.modelzoom = var20.modelzoom * 32 / var20.modelobjwidth;
                        } else if (var20.wsize > 0) {
                            var20.modelzoom = var20.modelzoom * 32 / var20.wsize;
                        }
                    }
                ...
                if (var1.intArg1 != var22.modelxof || var1.intArg2 != var22.modelyof || var1.intArg3 != var22.modelangle_z) {
                    var22.modelxof = var1.intArg1;
                    var22.modelyof = var1.intArg2;
                    var22.modelangle_z = var1.intArg3;
                    requestRedrawComponent(var22);
                }
            } else if (var2 == 11) {
                Component var23 = Component.get((int) var3);
                var23.xmode = 0;
                var23.x = var23.xpos = var1.intArg1;
                var23.ymode = 0;
                var23.y = var23.ypos = var1.intArg2;
                requestRedrawComponent(var23);
            } else if (var2 == 12) {
                Component var24 = Component.get((int) var3);
                int var25 = var1.intArg1;
                if (var24 != null && var24.type == 0) {
                    if (var25 > var24.scrollheight - var24.renderheight) {
                        var25 = var24.scrollheight - var24.renderheight;
                    }
                    if (var25 < 0) {
                        var25 = 0;
                    }
                ...
                var27.textfont = var1.intArg1;
            } else if (var2 == 20) {
                Component var28 = Component.get((int) var3);
                var28.fontmono = var1.intArg1 == 1;
            } else if (var2 == 21) {
                Component var29 = Component.get((int) var3);
                var29.clickmask = var1.intArg1 == 1;
            } else if (var2 == 17) {
                ...
                var31.setrecol(var32, (short) var1.intArg1, (short) var1.intArg2);
            } else if (var2 == 19) {
                Component var33 = Component.get((int) var3);
                int var34 = (int) (var3 >> 32);
                var33.setretex(var34, (short) var1.intArg1, (short) var1.intArg2);
            }
        }
    }
    ...
    public static final void updateEntityChats() {
        ...
        for (int var3 = 0; var3 < npcSlotCount; var3++) {
            long var4 = (long) npcSlots[var3];
            ObjectNode var6 = (ObjectNode) npcEntities.get(var4);
            if (var6 != null) {
        ...
        for (int var7 = 0; var7 < Statics.entities.length; var7++) {
            CutsceneEntity var8 = Statics.entities[var7];
            if (var8.exists) {
                var8.method2854().removeChatLine();
            }
        }
    }
    ...
    public static FullscreenMode[] getFullscreenModes() {
        if (Statics.field8518 == null) {
            FullscreenMode[] var0 = Fullscreen.method11507(GameShell.fsImpl);
            FullscreenMode[] var1 = new FullscreenMode[var0.length];
            int var2 = 0;
            int var3 = options.maxScreensize.method15794();
            label71:
            ...
            for (int var9 = 0; var9 < Statics.field8518.length; var9++) {
                ...
                var8[var9] = var10.width * var10.height;
            }
            Algorithms.quickSortParallel(var8, Statics.field8518);
        }
    ...
    public static final void applyCameraMoveAlong() {
        ...
        cameraX = (int) pos[0] - areaBase.x * 512;
        cameraY = (int) pos[1] * -1;
        cameraZ = (int) pos[2] - areaBase.z * 512;
        ...
        cameraPitch = (int) (Math.atan2((double) deltaY, delta) * 2607.5945876176133D) & 0x3FFF;
        cameraYaw = (int) (-Math.atan2((double) deltaX, (double) deltaZ) * 2607.5945876176133D) & 0x3FFF;
        cameraRoll = (cameraSplineRate * (cameraSpline[cameraSplinePos][posIdx + 2][3] - cameraSpline[cameraSplinePos][posIdx][3]) >> 16) + cameraSpline[cameraSplinePos][posIdx][3];
    }

    @ObfuscatedName("su.gx(B)V")
    public static final void applyCameraCutscene() {
        int var0 = cameraMoveToX * 512 + 256;
        int var1 = cameraMoveToZ * 512 + 256;
        int var2 = getHeightmapY(var0, var1, Statics.currentPlayerLevel) - Statics.cameraMoveToY;
        if (cameraMoveToRate >= 100) {
            cameraX = cameraMoveToX * 512 + 256;
            cameraZ = cameraMoveToZ * 512 + 256;
            cameraY = getHeightmapY(cameraX, cameraZ, Statics.currentPlayerLevel) - Statics.cameraMoveToY;
        } else {
            if (cameraX < var0) {
                cameraX += cameraMoveToRate * (var0 - cameraX) / 1000 + Statics.cameraMoveToStep;
                if (cameraX > var0) {
                    cameraX = var0;
                }
            }
            if (cameraX > var0) {
                cameraX -= cameraMoveToRate * (cameraX - var0) / 1000 + Statics.cameraMoveToStep;
                if (cameraX < var0) {
                    cameraX = var0;
                }
            }
            if (cameraY < var2) {
                cameraY += cameraMoveToRate * (var2 - cameraY) / 1000 + Statics.cameraMoveToStep;
                if (cameraY > var2) {
                    cameraY = var2;
                }
            }
            if (cameraY > var2) {
                cameraY -= cameraMoveToRate * (cameraY - var2) / 1000 + Statics.cameraMoveToStep;
                if (cameraY < var2) {
                    cameraY = var2;
                }
            }
            if (cameraZ < var1) {
                cameraZ += cameraMoveToRate * (var1 - cameraZ) / 1000 + Statics.cameraMoveToStep;
                if (cameraZ > var1) {
                    cameraZ = var1;
                }
            }
            if (cameraZ > var1) {
                cameraZ -= cameraMoveToRate * (cameraZ - var1) / 1000 + Statics.cameraMoveToStep;
                if (cameraZ < var1) {
                    cameraZ = var1;
                }
            }
        ...
        if (cameraPitch < var10) {
            cameraPitch += (var10 - cameraPitch >> 3) * Statics.cameraRotateSpeed / 1000 + Statics.cameraRotateAcceleration << 3;
            if (cameraPitch > var10) {
                cameraPitch = var10;
            }
        }
        if (cameraPitch > var10) {
            cameraPitch -= (cameraPitch - var10 >> 3) * Statics.cameraRotateSpeed / 1000 + Statics.cameraRotateAcceleration << 3;
            if (cameraPitch < var10) {
                cameraPitch = var10;
            }
        }
        ...
        int var13 = var12 >> 3;
        if (var13 > 0) {
            cameraYaw += Statics.cameraRotateSpeed * var13 / 1000 + Statics.cameraRotateAcceleration << 3;
            cameraYaw &= 0x3FFF;
        }
        if (var13 < 0) {
            cameraYaw -= Statics.cameraRotateSpeed * -var13 / 1000 + Statics.cameraRotateAcceleration << 3;
    ...
    public static final void cameraMoveTo(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        ...
        cameraMoveToRate = arg4;
        if (arg5 && cameraMoveToRate >= 100) {
            cameraX = cameraMoveToX * 512 + 256;
            cameraZ = cameraMoveToZ * 512 + 256;
            cameraY = getHeightmapY(cameraX, cameraZ, Statics.currentPlayerLevel) - Statics.cameraMoveToY;
        }
    ...
    public static final void cameraSmoothReset() {
        ...
        Statics.field1941 = -1;
        field9185 = loopCycle;
        Statics.field6412 = cameraX;
        Statics.field2632 = cameraY;
        Statics.field3493 = cameraZ;
        Statics.field6692 = cameraPitch;
        Statics.field7298 = cameraYaw;
    }
    ...
    public static final void updateNpcs() {
        for (int var0 = 0; var0 < npcSlotCount; var0++) {
            int var1 = npcSlots[var0];
            ObjectNode var2 = (ObjectNode) npcEntities.get((long) var1);
            if (var2 != null) {
    ...
    public static final void updateEntity(PathingEntity arg0, boolean arg1) {
        ...
        int var3 = 0;
        if (arg0.exactMoveT0 > loopCycle) {
            updateForceMovement(arg0);
        } else if (arg0.exactMoveT1 >= loopCycle) {
    ...
    public static final void updateForceMovement(PathingEntity arg0) {
        int var1 = arg0.exactMoveT0 - loopCycle;
        int var2 = arg0.exactMoveX0 * 512 + arg0.size() * 256;
        int var3 = arg0.exactMoveZ0 * 512 + arg0.size() * 256;
        Vector3 var4 = arg0.getTransform().trans;
        arg0.method8552((float) ((var2 - (int) var4.x) / var1 + (int) var4.x), (float) var4.y, (float) ((var3 - (int) var4.z) / var1 + (int) var4.z));
        arg0.field8648 = 0;
        arg0.method14013(arg0.exactMoveAngle);
    }
    ...
    public static final void startForceMovement(PathingEntity arg0) {
        ...
        if (loopCycle == arg0.exactMoveT1 || !var1.method11767() || var1.method11788(1)) {
            int var2 = arg0.exactMoveT1 - arg0.exactMoveT0;
            int var3 = loopCycle - arg0.exactMoveT0;
            int var4 = arg0.exactMoveX0 * 512 + arg0.size() * 256;
            int var5 = arg0.exactMoveZ0 * 512 + arg0.size() * 256;
            int var6 = arg0.exactMoveX1 * 512 + arg0.size() * 256;
            int var7 = arg0.exactMoveZ1 * 512 + arg0.size() * 256;
        ...
        arg0.field8648 = 0;
        arg0.turn(arg0.exactMoveAngle, false);
    }
    ...
    public static final void updateMovement(PathingEntity arg0, boolean arg1) {
        ...
        if (arg0.field8597.method11767() && !arg0.field8597.method11776()) {
            ...
            if (arg0.routeLength3 > 0 && var3.field6323 == 0) {
                arg0.field8648++;
                Statics.field6762 = MoveSpeed.STATIONARY.id;
                Statics.field2089 = 0;
                return;
            }
            if (arg0.routeLength3 <= 0 && var3.field6330 == 0) {
                arg0.field8648++;
                Statics.field6762 = MoveSpeed.STATIONARY.id;
                Statics.field2089 = 0;
                return;
        ...
        for (int var4 = 0; var4 < arg0.spotAnims.length; var4++) {
            if (arg0.spotAnims[var4].field1204 != -1 && arg0.spotAnims[var4].field1203.method11776()) {
                EffectAnimType var5 = field4213.method11082(arg0.spotAnims[var4].field1204);
                if (var5.field5264 && var5.field5252 != -1) {
                    SeqType var6 = Statics.field566.method11144(var5.field5252);
                    if (arg0.routeLength3 > 0 && var6.field6323 == 0) {
                        arg0.field8648++;
                        Statics.field6762 = MoveSpeed.STATIONARY.id;
                        Statics.field2089 = 0;
                        return;
                    }
                    if (arg0.routeLength3 <= 0 && var6.field6330 == 0) {
                        arg0.field8648++;
                        Statics.field6762 = MoveSpeed.STATIONARY.id;
                        Statics.field2089 = 0;
                        return;
        ...
        if (!arg1 && (var10 - var8 > 1024 || var10 - var8 < -1024 || var11 - var9 > 1024 || var11 - var9 < -1024)) {
            ...
            arg0.turn(arg0.field8637, false);
            arg0.routeLength--;
            if (arg0.routeLength3 > 0) {
                arg0.routeLength3--;
            }
            Statics.field6762 = MoveSpeed.STATIONARY.id;
            Statics.field2089 = 0;
        ...
        if (var14) {
            ...
            if (var15 != 0 && arg0.field8624 == -1 && arg0.turnspeed != 0) {
                var13 = 8;
            }
        ...
        if (var8 == var10 && var9 == var11) {
            ...
            if (var13 >= 32) {
                Statics.field6762 = MoveSpeed.RUN.id;
            } else {
        ...
        for (int var3 = 0; var3 < arg0.field8614.length; var3++) {
            ...
            if (var4 != -1) {
                ...
                if ((var4 & 0xc0000000) == 0xc0000000) {
                    ...
                    ObjectNode var16 = (ObjectNode) npcEntities.get((long) var4);
                    if (var16 == null) {
    ...
    public static void method12736(PathingEntity arg0, int arg1) {
        ...
        if (var3 != arg0.field8597.getSeqTypeId()) {
            ...
            arg0.routeLength3 = arg0.routeLength;
        }
    }
    ...
    public static void method3581(PathingEntity arg0, int arg1, int arg2, int arg3) {
        ...
        if (MoveSpeed.STATIONARY.id == arg1) {
            ...
            if (MoveSpeed.RUN.id == arg1 && var4.field4710 != -1) {
            ...
            } else if (MoveSpeed.CRAWL.id == arg1 && var4.field4702 != -1) {
    ...
    public static final void method2868() {
        ParticleSystemRenderer.method2847(toolkit, (long) loopCycle);
        if (topLevelInterface != -1) {
            method15619(topLevelInterface);
        }
        for (int var0 = 0; var0 < field9000; var0++) {
            field9166[var0] = topLevelComponentRedrawRequestedTemp[var0];
    ...
    public static final void method8591(long arg0) {
        ...
        for (int var2 = 0; var2 < field9000; var2++) {
            field9166[var2] = topLevelComponentRedrawRequestedTemp[var2];
    ...
    public static final void method14742(int arg0, int arg1, int arg2, int arg3, boolean arg4) {
        ...
        for (int var20 = 0; var20 < 5; var20++) {
            if (cameraModifierEnabled[var20]) {
                ...
                if (var20 == 3) {
                    cameraYaw = cameraYaw + var21 & 0x3FFF;
                }
                if (var20 == 4) {
                    cameraPitch += var21;
                    if (cameraPitch < 1024) {
        ...
        if (cameraX > (world.getScene().field4495 << 9) - 1) {
            cameraX = (world.getScene().field4495 << 9) - 1;
        }
        if (cameraZ < 0) {
            cameraZ = 0;
        }
        if (cameraZ > (world.getScene().field4496 << 9) - 1) {
            cameraZ = (world.getScene().field4496 << 9) - 1;
        }
        method4694();
        toolkit.method474(var7, var8, var9, var10);
        toolkit.r(var7, var8, var7 + var9, var8 + var10);
        ...
        if (CameraManager.method14782()) {
            ...
            field8925.method5114((float) -cameraX, (float) -cameraY, (float) -cameraZ);
            field8925.method5178(0.0F, -1.0F, 0.0F, Trig1.method5096(-cameraYaw & 0x3FFF));
            field8925.method5178(-1.0F, 0.0F, 0.0F, Trig1.method5096(-cameraPitch & 0x3FFF));
            field8925.method5178(0.0F, 0.0F, -1.0F, Trig1.method5096(-cameraRoll & 0x3FFF));
            method12142(field8924, true, (float) (var9 / 2), (float) (var10 / 2), (float) (field9205 << 1), (float) (field9205 << 1), var9, var10);
        }
        toolkit.method524(field8925);
        toolkit.method784(field8924);
        if (var22.getSkybox() == null) {
            toolkit.ba(3, var23);
        } else {
            toolkit.IA(1.0F);
            toolkit.m(16777215, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F);
            var22.getSkybox().method6369(toolkit, Statics.field3358 << 3, var7, var8, var9, var10, cameraPitch, cameraYaw, cameraRoll, var23, true, false);
        }
        MiniMenu.method2994(field8925, field8924, var9, var10);
        world.getEnvironmentManager().method8144(world);
        byte var26 = options.removeRoofOverride.getValue() == 2 ? (byte) field9042 : 1;
        if (CameraManager.method14782() || Statics.cameraState == 2) {
            world.getScene().method7419(loopCycle, var24.field2212, var24.field2211, var24.field2213, world.method6129(), field9058, field9222, field9097, field9061, field8945, Statics.localPlayerEntity.level + 1, var26, (int) var5.x >> 9, (int) var5.z >> 9, options.flickeringEffects.method15679() == 0, true, 0, true);
        } else {
            world.getScene().method7419(loopCycle, cameraX, cameraY, cameraZ, world.method6129(), field9058, field9222, field9097, field9061, field8945, Statics.localPlayerEntity.level + 1, var26, (int) var5.x >> 9, (int) var5.z >> 9, options.flickeringEffects.method15679() == 0, true, 0, true);
        }
        field9017++;
        ...
        cameraPitch = var18;
        cameraYaw = var19;
        if (field9226 && js5TcpClient.method5764() == 0) {
            field9226 = false;
        }
        if (field9226) {
            toolkit.fillRectangle(var7, var8, var9, var10, -16777216);
            Statics.method2579(LocalisedText.field6938.get(Statics.language), false, toolkit, Statics.field560, Statics.field9813);
        }
    ...
    public static final void method4694() {
        if (options.removeRoofOverride.getValue() != 2) {
            return;
        }
        ...
        if (Statics.cameraState != 4 && Statics.field1941 == -1) {
            int var11 = getHeightmapY(cameraX, cameraZ, Statics.currentPlayerLevel);
            if (var11 - cameraY < 3200 && (var9.levelTileFlags[Statics.currentPlayerLevel][cameraX >> 9][cameraZ >> 9] & 0x4) != 0) {
                method14118(var10.field4497, 1, cameraX >> 9, cameraZ >> 9, false);
            }
            return;
        }
        if (Statics.cameraState != 4) {
        ...
        if (var9.method5797(var12, var13)) {
            int var16 = getHeightmapY(cameraX, cameraZ, 3);
            if (cameraY >= var16) {
        ...
        if (var17 == 0 && var18 == 0 || var17 <= -world.getSizeX() || var17 >= world.getSizeX() || var18 <= -world.getSizeZ() || var18 >= world.getSizeZ()) {
            ...
            JagException.method16252(var12 + TextUtil.COMMA + var13 + " " + var14 + TextUtil.COMMA + var15 + " " + var23.x + TextUtil.COMMA + var23.z, new RuntimeException());
            return;
        }
        if (var17 <= var18) {
    ...
    public static final void method14608() {
        int var0 = ReceivePlayerPositions.highResolutionsCount;
        int[] var1 = ReceivePlayerPositions.highResolutionsIndices;
        int var2 = options.idleAnims.method15837();
        ...
        for (int var8 = 0; var8 < npcSlotCount; var8++) {
            NpcEntity var9 = (NpcEntity) ((ObjectNode) npcEntities.get((long) npcSlots[var8])).value;
            if (var9.method16154() && var9.type.method12517(localPlayerGameState)) {
                var9.method14006();
        ...
        for (int var12 = 0; var12 < field8936.length; var12++) {
            ...
            if (var13 != null) {
                if (var13.field776 == 1) {
                    ObjectNode var14 = (ObjectNode) npcEntities.get((long) var13.field772);
                    if (var14 != null) {
    ...
    public static final void method14538(int arg0) {
        ...
        for (int var6 = 0; var6 < var5; var6++) {
            PathingEntity var8;
            if (sceneState == 0) {
                CutsceneEntity var7 = Statics.entities[var6];
                if (!var7.exists) {
                    continue;
                }
                ...
                if (var6 < var1) {
                    ...
                    var8 = (PathingEntity) ((ObjectNode) npcEntities.get((long) npcSlots[var6 - var1])).value;
                }
    ...
    public static final void method14327(int arg0) {
        ...
        if (sceneState == 0) {
            ...
            var5 = field8939 ? var1 : npcSlotCount + var1;
        }
        for (int var6 = 0; var6 < var5; var6++) {
            PathingEntity var8;
            if (sceneState == 0) {
    ...
    public static final void method14328() {
        field9045 = 0;
        for (int var0 = 0; var0 < npcSlotCount; var0++) {
            NpcEntity var1 = (NpcEntity) ((ObjectNode) npcEntities.get((long) npcSlots[var0])).value;
            if (var1.field8634 && var1.method13961() != -1) {
                ...
                if (var6 != null) {
                    ...
                    field9153[field9045] = var7;
                    field9062[field9045] = var1.slot + 2048;
                    field9045++;
                    var6.field8598++;
                }
            }
    ...
    public static final void method14343() {
        ...
        int var2;
        if (sceneState == 0) {
            var2 = Statics.entities.length;
        } else {
            var2 = field8939 ? var0 : npcSlotCount + var0;
        }
        for (int var3 = 0; var3 < var2; var3++) {
            PathingEntity var5;
            if (sceneState == 0) {
                CutsceneEntity var4 = Statics.entities[var3];
                if (!var4.exists) {
                    continue;
                }
                ...
                if (var3 < var0) {
                    ...
                    var5 = (PathingEntity) ((ObjectNode) npcEntities.get((long) npcSlots[var3 - var0])).value;
                }
                if (var5.field8600 < 0) {
                    continue;
                }
    ...
    public static final void method12631(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        for (int var9 = 0; var9 < var8; var9++) {
            ...
            PathingEntity var12;
            if (sceneState == 0) {
                CutsceneEntity var11 = Statics.entities[var9];
                if (!var11.exists) {
                    continue;
                }
                ...
                if (var11.field1560 >= 0) {
                    ...
                    if (var10.multinpc != null) {
                        var10 = var10.getMultiNPC(localPlayerGameState);
                        if (var10 == null) {
                            continue;
                        }
                    }
                ...
                if (var9 < var6) {
                    ...
                    var12 = (PathingEntity) ((ObjectNode) npcEntities.get((long) npcSlots[var9 - var6])).value;
                    var10 = ((NpcEntity) var12).type;
                    if (var10.multinpc != null) {
                        var10 = var10.getMultiNPC(localPlayerGameState);
                        if (var10 == null) {
            ...
            if (!(field9048[0] < 0.0F)) {
                    ...
                    for (Headbar var17 = (Headbar) var12.field8612.method11649(); var17 != null; var17 = (Headbar) var12.field8612.method11644()) {
                        ...
                        if (var18 != null) {
                            ...
                            if (var20 != null && var20.field10065) {
                                var21 = var19.method7307(toolkit);
                                var22 = var19.method7301(toolkit);
                            } else {
                                var21 = var19.method7305(toolkit);
                                var22 = var19.method7304(toolkit);
                            }
                            if (var21 != null && var22 != null) {
                                ...
                                if (var23 >= 0 && var23 < 255) {
                                    ...
                                    toolkit.o(var32, var15, var29 + var32, var15 + var31);
                                ...
                                toolkit.r(arg0, arg1, arg0 + arg2, arg1 + arg3);
                                var15 -= 2;
                                var16 = true;
                            }
                ...
                if (!var16) {
                    var15 -= graphicsDefaults.field5164 + 2;
                }
                if (!var12.field8634) {
                    if (var10 == null) {
                ...
                if (!(var12 instanceof PlayerEntity)) {
                    ...
                    for (int var47 = 0; var47 < var46.length; var47++) {
                        ...
                        if (var48 != null && var48.field776 == 1 && var48.field772 == npcSlots[var9 - var6]) {
                ...
                for (int var53 = 0; var53 < graphicsDefaults.field5147; var53++) {
                    ...
                    if (var54 - var57 <= loopCycle) {
                        if (var56 == null) {
                            ...
                            if (field9048[0] > -1.0F) {
                                field9048[0] += graphicsDefaults.field5155[var53];
                                field9048[1] += graphicsDefaults.field5148[var53];
                                Object var61 = null;
                                Object var62 = null;
                                Object var63 = null;
                                Object var64 = null;
                                ...
                                int var84 = 0;
                                int var85 = 0;
                                Sprite var86 = var56.method7794(toolkit);
                                if (var86 != null) {
                                ...
                                Sprite var88 = var56.method7796(toolkit);
                                if (var88 != null) {
                                ...
                                Sprite var90 = var56.method7797(toolkit);
                                if (var90 != null) {
                                ...
                                Sprite var92 = var56.method7804(toolkit);
                                if (var92 != null) {
                                ...
                                if (var59 != null) {
                                    var73 = var59.method7794(toolkit);
                                    if (var73 != null) {
                                    ...
                                    var74 = var59.method7796(toolkit);
                                    if (var74 != null) {
                                    ...
                                    var75 = var59.method7797(toolkit);
                                    if (var75 != null) {
                                    ...
                                    var76 = var59.method7804(toolkit);
                                    if (var76 != null) {
                                ...
                                if (var102 >= 0) {
                                    Font var103 = (Font) Statics.fontProvider.method4859(fontFactory, var102, true, var56.field4742);
                                    FontMetrics var104 = Statics.fontProvider.method4843(fontFactory, var102);
                                ...
                                if (var59 != null) {
                                    ...
                                    if (var105 >= 0) {
                                        Font var106 = (Font) Statics.fontProvider.method4859(fontFactory, var105, true, var59.field4742);
                                        FontMetrics var107 = Statics.fontProvider.method4843(fontFactory, var105);
        ...
        for (int var152 = 0; var152 < field9045; var152++) {
            ...
            if (var153 < 2048) {
                ...
                var154 = (PathingEntity) ((ObjectNode) npcEntities.get((long) (var153 - 2048))).value;
            }
            ...
            if (var155 < 2048) {
                ...
                var156 = (PathingEntity) ((ObjectNode) npcEntities.get((long) (var155 - 2048))).value;
            }
        ...
        for (int var158 = 0; var158 < field9170; var158++) {
            ...
            if (field9107 == 0) {
                ...
                if (var171 == 4) {
                    ...
                    toolkit.o(arg0 + var159 - 50, arg1, arg0 + var159 + 50, arg1 + arg3);
                ...
                if (var171 == 5) {
                    ...
                    toolkit.o(arg0, arg1 + var160 - var177 - 1, arg0 + arg2, arg1 + var160 + 5);
    ...
    public static final void method12995(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        ...
        for (int var11 = 0; var11 < npcSlotCount; var11++) {
            int var12 = npcSlots[var11];
            ObjectNode var13 = (ObjectNode) npcEntities.get((long) var12);
            if (var13 != null) {
    ...
    public static final void method1979(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        ...
        field8925.method5115(toolkit.method525());
        field8925.method5116((float) arg3, 0.0F, 0.0F);
        toolkit.method524(field8925);
        if (arg5) {
            toolkit.method550((float) arg1, (float) var7, (float) arg2, field9048);
        } else {
            toolkit.method567((float) arg1, (float) var7, (float) arg2, field9048);
        }
        field8925.method5116((float) -arg3, 0.0F, 0.0F);
        toolkit.method524(field8925);
    ...
    public static final boolean readServerProt(ServerConnection arg0) {
        try {
            ...
            String var4 = (arg0.packetType == null ? -1 : arg0.packetType.id) + TextUtil.COMMA + (arg0.lastPacketType1 == null ? -1 : arg0.lastPacketType1.id) + TextUtil.COMMA + (arg0.lastPacketType2 == null ? -1 : arg0.lastPacketType2.id) + " " + arg0.packetSize + TextUtil.COMMA + (var3.x + Statics.localPlayerEntity.routeWaypointX[0]) + TextUtil.COMMA + (var3.z + Statics.localPlayerEntity.routeWaypointZ[0]) + " ";
    ...
    public static final boolean handleServerProt(ServerConnection conn) throws IOException {
        ...
        if (conn.packetSize > 0) {
            if (!stream.hasAvailable(conn.packetSize)) {
                return false;
            }
            buf.pos = 0;
            stream.read(buf.data, 0, conn.packetSize);
        ...
        if (ServerProt.field3010 == conn.packetType) {
            ...
            int var25 = buf.g2();
            incrementVerifyId();
            DelayedStateChange.setVarClientString(var25, var24);
            conn.packetType = null;
            return true;
            ...
            int var31 = buf.g4s();
            incrementVerifyId();
            DelayedStateChange.setType16(var30, var31);
            conn.packetType = null;
            return true;
            ...
            int var34 = buf.g2();
            incrementVerifyId();
            DelayedStateChange.setComponentModel(var33, 5, var34, var32);
            conn.packetType = null;
            return true;
        } else if (ServerProt.field3117 == conn.packetType) {
            int var35 = buf.g4s_alt2();
            incrementVerifyId();
            DelayedStateChange.setComponentModel(var35, 5, currentPlayerUid, 0);
            conn.packetType = null;
            return true;
            ...
            conn.packetType = null;
            return true;
        } else if (ServerProt.CLIENT_SETVARC_SMALL == conn.packetType) {
            byte var42 = buf.g1b();
            int var43 = buf.g2_alt3();
            incrementVerifyId();
            DelayedStateChange.setVarClientInt(var43, var42);
            conn.packetType = null;
            return true;
            ...
            method7731();
            if (options.field9667.method15884() == 1) {
                asyncRebuild.method6053(new RebuildRequest(RebuildType.REBUILD_REGION, var44));
            } else {
            ...
            incrementVerifyId();
            DelayedStateChange.setComponentModel(var66, 3, var67, var68);
            conn.packetType = null;
            return true;
            ...
            Statics.field6775 = WorldSwitcher.content;
            ...
            ObjectNode var77 = (ObjectNode) npcEntities.get((long) var76);
            if (var77 != null) {
            ...
            while (var94 > 0) {
                ...
                for (int var96 = 0; var96 < var94; var96++) {
                    ...
                    if (WorldSwitcher.content.field6768 != var98.field647 && WorldSwitcher.content.field6768 == var99.field647) {
                        var97 = true;
                    }
            ...
            conn.packetType = null;
            return true;
        } else if (ServerProt.IF_SETANIM == conn.packetType) {
            int var114 = buf.g4s_alt2();
            int var115 = buf.g4s_alt3();
            incrementVerifyId();
            DelayedStateChange.setComponentAnim(var115, var114);
            conn.packetType = null;
            return true;
            ...
            incrementVerifyId();
            DelayedStateChange.setType14(var116, var117);
            conn.packetType = null;
            return true;
            ...
            incrementVerifyId();
            DelayedStateChange.setVarClientString(var119, var120);
            conn.packetType = null;
            return true;
            ...
            int var128 = buf.g1();
            CreateAccountReply var129 = (CreateAccountReply) SerializableEnums.decode(CreateAccountReply.method2615(), var128);
            if (var129 == null) {
            ...
            method7731();
            if (options.field9667.method15884() == 1) {
                asyncRebuild.method6053(new RebuildRequest(RebuildType.REBUILD_NORMAL, var130));
            } else {
            ...
            incrementVerifyId();
            DelayedStateChange.setComponentModel(var155, 7, var156 << 16 | var154, var153);
            conn.packetType = null;
            return true;
            ...
            ReflectionCheck.push(buf, conn.packetSize);
            conn.packetType = null;
            return true;
            ...
            conn.packetType = null;
            return true;
        } else if (ServerProt.IF_SETOBJECT == conn.packetType) {
            int var188 = buf.g4s();
            ...
            ObjType var191 = objTypes.get(var190);
            ...
            incrementVerifyId();
            DelayedStateChange.setComponentHide(var201, var202);
            conn.packetType = null;
            return true;
            ...
            if (!field8903 || !Browser.method1814(var227, 1, var228)) {
                Browser.method5599(var227, true, options.toolkit.getValue() == 5, var228, field8915, field9218);
            }
            conn.packetType = null;
            return true;
            ...
            incrementVerifyId();
            DelayedStateChange.setType21(var231, var230);
            conn.packetType = null;
            return true;
            ...
            if (var252 != -1) {
                field9044[var251] = new HintTrail(toolkit, buf, var252);
            ...
            for (int var254 = 0; var254 < npcCount; var254++) {
                ((PathingEntity) npcs[var254].value).field8615 = null;
                ((PathingEntity) npcs[var254].value).field8597.method11769(-1);
            }
            conn.packetType = null;
            return true;
            ...
            for (ObjStackList var265 = (ObjStackList) field9088.head(); var265 != null; var265 = (ObjStackList) field9088.next()) {
                int var266 = (int) (var265.key >> 28 & 0x3L);
                int var267 = (int) (var265.key & 0x3FFFL);
                int var268 = var267 - var264.x;
                int var269 = (int) (var265.key >> 14 & 0x3FFFL);
            ...
            incrementVerifyId();
            DelayedStateChange.setType17(var282, var281);
            conn.packetType = null;
            return true;
            ...
            conn.packetType = null;
            return true;
        } else if (ServerProt.IF_SETCOLOUR == conn.packetType) {
            int var284 = buf.g2_alt1();
            int var285 = buf.g4s();
            incrementVerifyId();
            DelayedStateChange.setComponentColour(var285, var284);
            conn.packetType = null;
            return true;
        } else if (ServerProt.IF_CLOSESUB == conn.packetType) {
            int var286 = buf.g4s_alt1();
            incrementVerifyId();
            SubInterface var287 = (SubInterface) field9075.get((long) var286);
            if (var287 != null) {
            ...
            DelayedStateChange.setMiniMapFlag(var294, var295);
            conn.packetType = null;
            return true;
            ...
            incrementVerifyId();
            DelayedStateChange.setComponentText(var314, var313);
            conn.packetType = null;
            return true;
        } else if (ServerProt.field3050 == conn.packetType) {
            publicChatFilter = buf.g1_alt2();
            ...
            incrementVerifyId();
            DelayedStateChange.setComponentModel(var344, 1, var345, -1);
            conn.packetType = null;
            return true;
            ...
            int var348 = buf.g4s();
            incrementVerifyId();
            DelayedStateChange.setType13(var348, (var346 << 16) + var347);
            conn.packetType = null;
            return true;
            ...
            int var362 = buf.g2();
            localPlayerGameState.method1663(var362, var361);
            conn.packetType = null;
            return true;
        } else if (ServerProt.VARP_LARGE == conn.packetType) {
            int var363 = buf.g4s_alt1();
            int var364 = buf.g2_alt2();
            localPlayerGameState.method1643(var364, var363);
            conn.packetType = null;
            return true;
            ...
            incrementVerifyId();
            DelayedStateChange.setType12(var365, var366);
            conn.packetType = null;
            return true;
            ...
            conn.packetType = null;
            return true;
        } else if (ServerProt.IF_SETCLICKMASK == conn.packetType) {
            int var422 = buf.g4s_alt3();
            boolean var423 = buf.g1() == 1;
            incrementVerifyId();
            DelayedStateChange.setComponentClickMask(var422, var423);
            conn.packetType = null;
            return true;
            ...
            if (var425) {
                ...
                Browser.method3613(var427, true, options.toolkit.getValue() == 5, field8915, field9218);
            }
            conn.packetType = null;
            return true;
            ...
            Statics.field6803 = buf.g1b() << 3;
            while (buf.pos < conn.packetSize) {
                ZoneProt var431 = ZoneProt.method8301()[buf.g1()];
            ...
            localPlayerGameState.method1663(var433, var434);
            conn.packetType = null;
            return true;
            ...
            conn.packetType = null;
            return true;
        } else if (ServerProt.IF_SETANGLE == conn.packetType) {
            int var455 = buf.g4s_alt1();
            int var456 = buf.g2();
            int var457 = buf.g2();
            int var458 = buf.g2_alt2();
            incrementVerifyId();
            DelayedStateChange.setComponentModelAngle(var455, var458, var457, var456);
            conn.packetType = null;
            return true;
        } else if (ServerProt.VARP_SMALL == conn.packetType) {
            byte var459 = buf.g1b_alt3();
            int var460 = buf.g2_alt1();
            localPlayerGameState.method1643(var460, var459);
            conn.packetType = null;
            return true;
            ...
            if (var461 >> 30 != 0) {
                ...
                if (var472 >= 0 && var473 >= 0 && var472 < world.getSizeX() && var473 < world.getSizeZ()) {
                    if (var462 == -1) {
                        SpotAnimationEntityNode var474 = (SpotAnimationEntityNode) field9090.get((long) (var472 << 16 | var473));
                        if (var474 != null) {
                ...
                ObjectNode var480 = (ObjectNode) npcEntities.get((long) var479);
                if (var480 != null) {
                    ...
                    if (var462 != -1 && var484 != -1) {
                        if (var462 == var484) {
                            EffectAnimType var485 = field4213.method11082(var462);
                            ...
                            EffectAnimType var488 = field4213.method11082(var462);
                            EffectAnimType var489 = field4213.method11082(var484);
                    ...
                    if (var483) {
                        ...
                        if (var462 == -1) {
                            ...
                            EffectAnimType var492 = field4213.method11082(var462);
                ...
                if (var495 != null) {
                    ...
                    if (var462 != -1 && var498 != -1) {
                        if (var462 == var498) {
                            EffectAnimType var499 = field4213.method11082(var462);
                            ...
                            EffectAnimType var502 = field4213.method11082(var462);
                            EffectAnimType var503 = field4213.method11082(var498);
                    ...
                    if (var497) {
                        ...
                        if (var462 == -1) {
                            ...
                            EffectAnimType var506 = field4213.method11082(var462);
            ...
            incrementVerifyId();
            DelayedStateChange.setComponentModel(var525, 3, currentPlayerUid, 0);
            conn.packetType = null;
            return true;
            ...
            incrementVerifyId();
            DelayedStateChange.setComponentModel(combinedId, 2, npcId, -1);
            conn.packetType = null;
            return true;
            ...
            conn.packetType = null;
            return true;
        } else if (ServerProt.IF_SETPOSITION == conn.packetType) {
            int var547 = buf.g2s_alt1();
            int var548 = buf.g4s_alt3();
            int var549 = buf.g2s_alt3();
            incrementVerifyId();
            DelayedStateChange.setComponentPosition(var548, var549, var547);
            conn.packetType = null;
            return true;
            ...
            incrementVerifyId();
            DelayedStateChange.setType18(var554, var555, var556, var553);
            conn.packetType = null;
            return true;
            ...
            incrementVerifyId();
            DelayedStateChange.setVarClientInt(var563, var562);
            conn.packetType = null;
            return true;
        } else if (ServerProt.field2994 == conn.packetType) {
            localPlayerGameState.method1647();
            varpTransmitNum += 32;
            conn.packetType = null;
            return true;
            ...
            int var572 = buf.g2();
            incrementVerifyId();
            DelayedStateChange.setType19(var569, var571, var572, var570);
            conn.packetType = null;
            return true;
            ...
            for (int var581 = 0; var581 < 100; var581++) {
                topLevelComponentRedrawRequestedTemp[var581] = true;
            }
            conn.packetType = null;
            return true;
            ...
            incrementVerifyId();
            SubInterface var584 = (SubInterface) field9075.get((long) var582);
            SubInterface var585 = (SubInterface) field9075.get((long) var583);
            if (var585 != null) {
            ...
            long var589 = buf.g8();
            field9182 = Base37.method5925(var589);
            ...
            JagException.method16252((conn.packetType == null ? -1 : conn.packetType.id) + TextUtil.COMMA + (conn.lastPacketType1 == null ? -1 : conn.lastPacketType1.id) + TextUtil.COMMA + (conn.lastPacketType2 == null ? -1 : conn.lastPacketType2.id) + " " + conn.packetSize, new RuntimeException());
            logout(false);
            return true;
        }
    }
    ...
    public static final void handleZoneProt(ZoneProt arg0) {
        ...
        if (ZoneProt.field2806 == arg0) {
            ...
            int var10 = buf.g2();
            if (field9088 != null) {
                ObjStackList var11 = (ObjStackList) field9088.get((long) (Statics.field3161 << 28 | var5 << 14 | var7));
                if (var11 != null) {
            ...
            ObjStackList var20 = (ObjStackList) field9088.get((long) (Statics.field3161 << 28 | var17 << 14 | var19));
            if (var20 != null) {
            ...
            if (world.method6132() != RebuildType.field3839 && (var60 >= 0 && var61 >= 0 && var60 < world.getSizeX() && var61 < world.getSizeZ())) {
                if (var62 == -1) {
                    SpotAnimationEntityNode var67 = (SpotAnimationEntityNode) field9090.get((long) (var60 << 16 | var61));
                    if (var67 != null) {
    ...
    public static void method11367(int arg0, int arg1, int arg2, Obj arg3) {
        ...
        ObjStackList var6 = (ObjStackList) field9088.get(var4);
        if (var6 == null) {
    ...
    public static void sortObjStacks(int arg0, int arg1, int arg2) {
        ...
        ObjStackList var8 = (ObjStackList) field9088.get(var6);
        if (var8 == null) {
        ...
        world.getScene().addObjStack(arg0, arg1, arg2, var14, var10);
    }

    @ObfuscatedName("fw.jq(ZB)V")
    public static final void receiveNpcInfo(boolean large) {
        removedNpcCount = 0;
        extendedInfoNpcCount = 0;
        field8971++;
        updateLocalNpcs();
        updateNpcsAddChange(large);
        updateNpcsExtendedInfo();
        boolean var1 = false;
        for (int var2 = 0; var2 < removedNpcCount; var2++) {
            int var3 = removedNpcSlots[var2];
            ObjectNode var4 = (ObjectNode) npcEntities.get((long) var3);
            NpcEntity var5 = (NpcEntity) var4.value;
            if (field8971 != var5.field8618) {
                if (MiniMenu.open && MiniMenu.method11169(var3)) {
                    MiniMenu.close();
                }
                if (var5.type.hasSound()) {
                    PositionedSound.remove(var5);
                }
                var5.setType(null);
                var4.unlink();
                var1 = true;
        ...
        if (var1) {
            int var6 = npcCount;
            npcCount = npcEntities.size();
            int var7 = 0;
            Iterator var8 = npcEntities.iterator();
            while (var8.hasNext()) {
        ...
        for (int var11 = 0; var11 < npcSlotCount; var11++) {
            if (npcEntities.get((long) npcSlots[var11]) == null) {
                throw new RuntimeException(var11 + " " + npcSlotCount);
            }
        }
        ...
        for (int var12 = 0; var12 < npcCount; var12++) {
            if (field8971 != ((PathingEntity) npcs[var12].value).field8618) {
                throw new RuntimeException("" + ((PathingEntity) npcs[var12].value).slot);
            }
        }
    }

    @ObfuscatedName("qq.jk(B)V")
    public static final void updateLocalNpcs() {
        PacketBit buf = gameConnection.in;
        buf.bits();
        int var1 = buf.gBit(8);
        if (var1 < npcSlotCount) {
            for (int var2 = var1; var2 < npcSlotCount; var2++) {
                removedNpcSlots[++removedNpcCount - 1] = npcSlots[var2];
            }
        }
        if (var1 > npcSlotCount) {
        ...
        npcSlotCount = 0;
        for (int var3 = 0; var3 < var1; var3++) {
            int var4 = npcSlots[var3];
            NpcEntity var5 = (NpcEntity) ((ObjectNode) npcEntities.get((long) var4)).value;
            int var6 = buf.gBit(1);
            if (var6 == 0) {
                ...
                if (var7 == 0) {
                    npcSlots[++npcSlotCount - 1] = var4;
                    var5.field8618 = field8971;
                    extendedInfoNpcSlots[++extendedInfoNpcCount - 1] = var4;
                } else if (var7 == 1) {
                    npcSlots[++npcSlotCount - 1] = var4;
                    var5.field8618 = field8971;
                    ...
                    removedNpcSlots[++removedNpcCount - 1] = var4;
                }
            }
        }
    }
    ...
    public static final void updateNpcsAddChange(boolean arg0) {
        PacketBit buf = gameConnection.in;
        while (buf.bitsAvailable(gameConnection.packetSize) >= 15) {
            ...
            boolean var3 = false;
            ObjectNode var4 = (ObjectNode) npcEntities.get((long) var2);
            if (var4 == null) {
                NpcEntity var5 = new NpcEntity(world.getScene());
                var5.slot = var2;
                var4 = new ObjectNode(var5);
                npcEntities.put(var4, (long) var2);
                npcs[++npcCount - 1] = var4;
                var3 = true;
            }
            NpcEntity var6 = (NpcEntity) var4.value;
            npcSlots[++npcSlotCount - 1] = var2;
            var6.field8618 = field8971;
            if (var6.type != null && var6.type.hasSound()) {
                PositionedSound.remove(var6);
            }
            var6.setType(npcTypes.get(buf.gBit(15)));
            int var7 = buf.gBit(1);
            if (var7 == 1) {
                extendedInfoNpcSlots[++extendedInfoNpcCount - 1] = var2;
            }
            ...
            var6.setSize(var6.type.size);
            var6.turnspeed = var6.type.turnspeed << 3;
            if (var3) {
                var6.turn(var8, true);
            }
            var6.move(var11, Statics.localPlayerEntity.routeWaypointX[0] + var10, Statics.localPlayerEntity.routeWaypointZ[0] + var12, var9 == 1, var6.size());
            if (var6.type.hasSound()) {
    ...
    public static final void updateNpcsExtendedInfo() {
        PacketBit buf = gameConnection.in;
        for (int var1 = 0; var1 < extendedInfoNpcCount; var1++) {
            int var2 = extendedInfoNpcSlots[var1];
            NpcEntity var3 = (NpcEntity) ((ObjectNode) npcEntities.get((long) var2)).value;
            ...
            if ((extendedInfo & 0x800000) != 0) {
                ...
                if (var3.vislevel == 65535) {
                    var3.vislevel = var3.type.vislevel;
                }
            }
            if ((extendedInfo & 0x8000) != 0) {
                var3.exactMoveX0 = buf.g1b();
                var3.exactMoveZ0 = buf.g1b();
                var3.exactMoveX1 = buf.g1b_alt3();
                var3.exactMoveZ1 = buf.g1b_alt1();
                var3.exactMoveT0 = buf.g2_alt3() + loopCycle;
                var3.exactMoveT1 = buf.g2() + loopCycle;
                var3.exactMoveAngle = buf.g2();
                var3.exactMoveX0 = var3.exactMoveX0 + var3.routeWaypointX[0];
                var3.exactMoveZ0 = var3.exactMoveZ0 + var3.routeWaypointZ[0];
                var3.exactMoveX1 = var3.exactMoveX1 + var3.routeWaypointX[0];
                var3.exactMoveZ1 = var3.exactMoveZ1 + var3.routeWaypointZ[0];
                var3.routeLength = 1;
                var3.routeLength3 = 0;
            }
            ...
            if ((extendedInfo & 0x80) != 0) {
                if (var3.type.hasSound()) {
                    PositionedSound.remove(var3);
                }
                var3.setType(npcTypes.get(buf.gSmart2or4null()));
                var3.setSize(var3.type.size);
                var3.turnspeed = var3.type.turnspeed << 3;
                if (var3.type.hasSound()) {
    ...
    public static final void method4593() {
        ...
        method11892(topLevelInterface, 0, 0, GameShell.canvasWid, GameShell.canvasHei, 0, 0, -1);
        if (Statics.field4667 != null) {
            method2709(Statics.field4667, -1412584499, 0, 0, GameShell.canvasWid, GameShell.canvasHei, Statics.field562, Statics.field5185, Statics.field9561 == field9116 ? -1 : field9116.field1926, true);
            Statics.field4667 = null;
        }
    }
    ...
    public static final void method2709(Component[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, boolean arg9) {
        toolkit.r(arg2, arg3, arg4, arg5);
        for (int var10 = 0; var10 < arg0.length; var10++) {
            Component var11 = arg0[var10];
            if (var11 != null && (var11.field1886 == arg1 || arg1 == -1412584499 && dragComponent == var11)) {
                int var12;
                if (arg8 == -1) {
                    field9167[field9000].setBounds(var11.x + arg6, var11.y + arg7, var11.renderwidth, var11.renderheight);
                    var12 = ++field9000 - 1;
                } else {
                    var12 = arg8;
                }
                ...
                if (!method14315(var11)) {
                    ...
                    if (var20 < var22 && var21 < var23) {
                        if (var11.clientcode != 0) {
                            ...
                            if (Component.MINIMAP == var11.clientcode && sceneState == 2) {
                                if (var11.method3124(toolkit) != null) {
                                    AudioRenderer.method3461();
                                    MiniMap.method3655(toolkit, var11, var13, var14);
                                    toolkit.r(arg2, arg3, arg4, arg5);
                                }
                            ...
                            if (Component.COLOR_CHOOSER_HUE == var11.clientcode) {
                                WorldMapRenderer.method8599(toolkit, var13, var14, var11);
                                continue;
                            }

                            if (Component.COLOR_CHOOSER_SAT == var11.clientcode) {
                                WorldMapRenderer.method3303(toolkit, var13, var14, var11, var11.colour % 64);
                                continue;
                            }
                            ...
                            if (Component.WORLD_MAP == var11.clientcode) {
                                ClientWorldMap.drawMain(toolkit, Statics.field8465, var13, var14, var11.renderwidth, var11.renderheight);
                                topLevelComponentRedrawRequestedTemp[var12] = true;
                                toolkit.r(arg2, arg3, arg4, arg5);
                                continue;
                            }
                            ...
                            if (Component.WORLD_MAP_OVERVIEW == var11.clientcode) {
                                ClientWorldMap.drawOverview(toolkit, var13, var14, var11.renderwidth, var11.renderheight);
                                topLevelComponentRedrawRequestedTemp[var12] = true;
                                toolkit.r(arg2, arg3, arg4, arg5);
                                continue;
                            }
                        ...
                        if (var11.type == 0) {
                            if (Component.CUTSCENE_FADE == var11.clientcode && toolkit.isBloomEnabled()) {
                                toolkit.method514(0, 0, GameShell.canvasWid, GameShell.canvasHei);
                            }
                            ...
                            if (Component.CUTSCENE_FADE == var11.clientcode) {
                                ...
                                if (sceneState == 0) {
                                    ...
                                    if (var27 > 0) {
                                        toolkit.fillRectangle(var20, var21, var22 - var20, var23 - var21, var27 << 24 | var28 << 16 | var29 << 8 | var30);
                                    }
                                }
                            }
                        ...
                        if (field9166[var12] || field8929 > 1) {
                            if (var11.type == 3) {
                                if (var15 == 0) {
                                    if (var11.field1741) {
                                        toolkit.B(var13, var14, var11.renderwidth, var11.renderheight, var11.colour | 0xFF000000, 0);
                                    } else {
                                        toolkit.drawRectangle(var13, var14, var11.renderwidth, var11.renderheight, var11.colour | 0xFF000000, 0);
                                    }
                                } else if (var11.field1741) {
                                    toolkit.B(var13, var14, var11.renderwidth, var11.renderheight, 255 - (var15 & 0xFF) << 24 | var11.colour & 0xFFFFFF, 1);
                                } else {
                                    toolkit.drawRectangle(var13, var14, var11.renderwidth, var11.renderheight, 255 - (var15 & 0xFF) << 24 | var11.colour & 0xFFFFFF, 1);
                                }
                            } else if (var11.type == 4) {
                                int var32 = 255 - (var15 & 0xFF);
                                if (var32 != 0) {
                                    Font var33 = var11.method3116(Statics.fontProvider, fontFactory);
                                    if (var33 != null) {
                                        int var34 = var11.colour;
                                        String var35 = var11.text;
                                        if (var11.invobject != -1) {
                                            ObjType var36 = objTypes.get(var11.invobject);
                                            var35 = var36.name;
                                            if (var35 == null) {
                                                var35 = "null";
                                            }
                                        ...
                                        if (field9114) {
                                            toolkit.o(var13, var14, var11.renderwidth + var13, var11.renderheight + var14);
                                        }
                                        int var37 = var32 << 24;
                                ...
                                if (var11.field1906 >= 0) {
                                    var11.method3181(Statics.field4678, Statics.field6360).method6368(toolkit, 0, var13, var14, var11.renderwidth, var11.renderheight, var11.field1907 << 3, var11.field1908 << 3, 0, 0);
                                } else {
                                    Sprite var39;
                                    if (var11.invobject != -1) {
                                        PlayerModel var38 = var11.invwearcol ? Statics.localPlayerEntity.model : null;
                                        var39 = objTypes.getCachedIcon(toolkit, var11.invobject, var11.invcount, var11.outline, var11.graphicshadow | 0xFF000000, var11.invcountvis, var38);
                                    } else if (var11.field1737 == -1) {
                                        var39 = var11.method3151(toolkit);
                                    } else {
                                        var39 = VideoTypeList.method4742(toolkit, var11.field1737);
                                    }
                                    if (var39 != null) {
                                ...
                                int var52 = 0;
                                if (var11.invobject != -1) {
                                    ObjType var53 = objTypes.get(var11.invobject);
                                    if (var53 != null) {
                                        ObjType var54 = var53.method12242(var11.invcount);
                                        var50 = var54.method12241(toolkit, var51, 1, var11.invwearcol ? Statics.localPlayerEntity.model : null, var11.modelAnimator, 0, 0, 0, 0);
                                        if (var50 == null) {
                                            requestRedrawComponent(var11);
                                        } else {
                                            var52 = -var50.YA() >> 1;
                                    ...
                                    if (var55 >= 0 && var55 < 2048) {
                                        ...
                                        if (var56 != null && (currentPlayerUid == var55 || StringTools.method1347(var56.nameUnfiltered) == var11.field1832)) {
                                            var50 = var11.method3174(toolkit, var51, Statics.field3769, Statics.field7650, npcTypes, objTypes, Statics.field566, localPlayerGameState, var11.modelAnimator, var56.model);
                                    ...
                                    if (var57 >= 0 && var57 < 2048) {
                                        ...
                                        if (var58 != null && (currentPlayerUid == var57 || StringTools.method1347(var58.nameUnfiltered) == var11.field1832)) {
                                            var50 = var58.model.method8244(toolkit, var51, Statics.field3769, Statics.field7650, npcTypes, objTypes, Statics.field566, localPlayerGameState, var11.modelAnimator, null, null, null, 0, true, Statics.wearposDefaults);
                                        }
                                    }
                                } else if (var11.modelkind == 8 || var11.modelkind == 9) {
                                    ClientInvCache var59 = ClientInvCache.method11708(var11.model, false);
                                    if (var59 != null) {
                                        var50 = var59.method14751(toolkit, var51, var11.modelAnimator, var11.field1832, var11.modelkind == 9, var11.invwearcol ? Statics.localPlayerEntity.model : null);
                                    }
                                } else if (var11.modelAnimator != null && var11.modelAnimator.method11767()) {
                                    var50 = var11.method3174(toolkit, var51, Statics.field3769, Statics.field7650, npcTypes, objTypes, Statics.field566, localPlayerGameState, var11.modelAnimator, Statics.localPlayerEntity.model);
                                    if (var50 == null && Component.field1761) {
                                        requestRedrawComponent(var11);
                                    }
                                } else {
                                    var50 = var11.method3174(toolkit, var51, Statics.field3769, Statics.field7650, npcTypes, objTypes, Statics.field566, localPlayerGameState, null, Statics.localPlayerEntity.model);
                                    if (var50 == null && Component.field1761) {
                                        requestRedrawComponent(var11);
                                    }
                                }
                                if (var50 != null) {
                                    ...
                                    if (var11.modelobjwidth > 0) {
                                        var60 = (var11.renderwidth << 9) / var11.modelobjwidth;
                                    } else {
                                        var60 = 512;
                                    }
                                    int var61;
                                    ...
                                    toolkit.method524(field8925);
                                    Matrix4x4 var64 = toolkit.method781();
                                    int var65 = world.method6096();
                                    int var66 = world.method6108();
                                    int var67 = var11.modelzoom + var66;
                                    if (var11.field1821) {
                                        if (Statics.cameraState == 2) {
                                            if (var11.field1816) {
                                                var64.method5398((float) var62, (float) var63, (float) var60, (float) var61, Statics.cam2.method3732(), Statics.cam2.method3778(), (float) GameShell.canvasWid, (float) GameShell.canvasHei, (float) var11.modelzoom);
                                            } else {
                                                var64.method5398((float) var62, (float) var63, (float) var60, (float) var61, Statics.cam2.method3732(), Statics.cam2.method3778(), (float) GameShell.canvasWid, (float) GameShell.canvasHei, (float) (var11.modelzoom << 2));
                                            }
                                        } else if (var11.field1816) {
                                            var64.method5398((float) var62, (float) var63, (float) var60, (float) var61, (float) var65, (float) var67, (float) GameShell.canvasWid, (float) GameShell.canvasHei, (float) var11.modelzoom);
                                        } else {
                                            var64.method5398((float) var62, (float) var63, (float) var60, (float) var61, (float) var65, (float) var67, (float) GameShell.canvasWid, (float) GameShell.canvasHei, (float) (var11.modelzoom << 2));
                                        }
                                    } else if (Statics.cameraState == 2) {
                                        var64.method5397((float) var62, (float) var63, (float) var60, (float) var61, Statics.cam2.method3732(), Statics.cam2.method3778(), (float) GameShell.canvasWid, (float) GameShell.canvasHei);
                                    } else {
                                        var64.method5397((float) var62, (float) var63, (float) var60, (float) var61, (float) var65, (float) var67, (float) GameShell.canvasWid, (float) GameShell.canvasHei);
                                    }
                                    toolkit.method784(var64);
                                    toolkit.ba(2, 0);
                                    if (var11.field1822) {
                                        toolkit.RA(false);
                                    }
                                    if (var11.field1816) {
                                        field8979.setToRotation(1.0F, 0.0F, 0.0F, Trig1.method5096(var11.modelangle_x));
                                        field8979.method5178(0.0F, 1.0F, 0.0F, Trig1.method5096(var11.modelangle_y));
                                        field8979.method5178(0.0F, 0.0F, 1.0F, Trig1.method5096(var11.modelangle_z));
                                        field8979.method5116((float) var11.field1811, (float) var11.field1916, (float) var11.field1817);
                                    } else {
                                        int var68 = (var11.modelzoom << 2) * Trig1.sin[var11.modelangle_x << 3] >> 14;
                                        int var69 = (var11.modelzoom << 2) * Trig1.cos[var11.modelangle_x << 3] >> 14;
                                        field8979.setToRotation(0.0F, 0.0F, 1.0F, Trig1.method5096(-var11.modelangle_z << 3));
                                        field8979.method5178(0.0F, 1.0F, 0.0F, Trig1.method5096(var11.modelangle_y << 3));
                                        field8979.method5116((float) (var11.modelxof << 2), (float) ((var11.modelyof << 2) + var68 + var52), (float) ((var11.modelyof << 2) + var69));
                                        field8979.method5178(1.0F, 0.0F, 0.0F, Trig1.method5096(var11.modelangle_x << 3));
                                    }
                                    var11.method3119(toolkit, var50, field8979, loopCycle);
                                    toolkit.method515(true);
                                    toolkit.r(arg2, arg3, arg4, arg5);
                                    if (field9114) {
                                        toolkit.o(var13, var14, var11.renderwidth + var13, var11.renderheight + var14);
                                    }
                                    ...
                                    if (!var11.field1821 && var11.field1840 != null) {
                                        toolkit.method733(var11.field1840.method8109());
                                    }
                                    if (field9114) {
                                        toolkit.r(arg2, arg3, arg4, arg5);
                                    }
                                    toolkit.method515(false);
                                    toolkit.L();
                                    toolkit.r(arg2, arg3, arg4, arg5);
                                    if (var11.field1822) {
                                        toolkit.RA(true);
                                ...
                                if (var11.field1791 == 1) {
                                    toolkit.method825(var70, var71, var72, var73, var11.colour | 0xFF000000, 0);
                                } else {
                                    toolkit.method499(var70, var71, var72, var73, var11.colour | 0xFF000000, var11.field1791, 0);
                                }
                            }
                        }
                    }
    ...
    public static final void computeTopLevelInterfaceLayout(boolean arg0) {
        method11241(topLevelInterface, GameShell.canvasWid, GameShell.canvasHei, arg0);
    }
    ...
    public static void method5831(Component[] arg0, Component arg1, boolean arg2) {
        ...
        int var4 = arg1.scrollheight == 0 ? arg1.renderheight : arg1.scrollheight;
        ...
        SubInterface var5 = (SubInterface) field9075.get((long) arg1.id);
        if (var5 != null) {
        ...
        for (int var10 = 0; var10 < npcSlotCount; var10++) {
            int var11 = npcSlots[var10];
            ObjectNode var12 = (ObjectNode) npcEntities.get((long) var11);
            if (var12 != null) {
    ...
    public static void method11323(Component[] arg0, int arg1, int arg2, int arg3, boolean arg4) {
        for (int var5 = 0; var5 < arg0.length; var5++) {
            ...
            if (var6 != null && var6.field1886 == arg1) {
                ...
                if (var6.scrolly > var6.scrollheight - var6.renderheight) {
                    var6.scrolly = var6.scrollheight - var6.renderheight;
                }
                if (var6.scrolly < 0) {
                    var6.scrolly = 0;
                }
    ...
    public static void method8063(Component arg0, int arg1, int arg2, boolean arg3) {
        ...
        if (arg0.field1856 == 0) {
            arg0.renderwidth = arg0.wsize;
        } else if (arg0.field1856 == 1) {
            arg0.renderwidth = arg1 - arg0.wsize;
        } else if (arg0.field1856 == 2) {
            arg0.renderwidth = arg0.wsize * arg1 >> 14;
        }
        if (arg0.field1771 == 0) {
    ...
    public static void method1742(Component arg0, int arg1, int arg2) {
        if (arg0.xmode == 0) {
            ...
            arg0.x = (arg1 - arg0.renderwidth) / 2 + arg0.xpos;
        } else if (arg0.xmode == 2) {
            arg0.x = arg1 - arg0.renderwidth - arg0.xpos;
        } else if (arg0.xmode == 3) {
            arg0.x = arg0.xpos * arg1 >> 14;
        } else if (arg0.xmode == 4) {
            arg0.x = (arg0.xpos * arg1 >> 14) + (arg1 - arg0.renderwidth) / 2;
        } else {
            arg0.x = arg1 - arg0.renderwidth - (arg0.xpos * arg1 >> 14);
        }
        if (arg0.ymode == 0) {
            arg0.y = arg0.ypos;
        } else if (arg0.ymode == 1) {
            arg0.y = (arg2 - arg0.renderheight) / 2 + arg0.ypos;
        } else if (arg0.ymode == 2) {
            arg0.y = arg2 - arg0.renderheight - arg0.ypos;
        } else if (arg0.ymode == 3) {
            arg0.y = arg0.ypos * arg2 >> 14;
        } else if (arg0.ymode == 4) {
            arg0.y = (arg0.ypos * arg2 >> 14) + (arg2 - arg0.renderheight) / 2;
        } else {
            arg0.y = arg2 - arg0.renderheight - (arg0.ypos * arg2 >> 14);
        }
        if (!field9111 || getComponentEvents(arg0).events == 0 && arg0.type != 0) {
            return;
        }
        if (arg0.x < 0) {
            arg0.x = 0;
        } else if (arg0.renderwidth + arg0.x > arg1) {
            arg0.x = arg1 - arg0.renderwidth;
        }
        if (arg0.y < 0) {
            arg0.y = 0;
        } else if (arg0.renderheight + arg0.y > arg2) {
            arg0.y = arg2 - arg0.renderheight;
        }
    }
    ...
    public static final void updateTopLevelInterface() {
        ...
        if (dragComponent != null && Statics.field9561 == field9116) {
            ...
            field9203 = 0;
            field8942 = 0;
            field9123 = GameShell.canvasWid;
            field8968 = GameShell.canvasHei;
        }
        updateInterface(null, topLevelInterface, 0, 0, GameShell.canvasWid, GameShell.canvasHei, 0, 0, var0, var1);
        if (Statics.field4960 != null) {
                ...
                if (var12.type == 0 || var12.hashook || getComponentEvents(var12).events != 0 || field9116 == var12 || Component.MINIMAP == var12.clientcode || Component.MOUSE_OVER_TEXT == var12.clientcode || Component.field1847 == var12.clientcode || Component.field1742 == var12.clientcode) {
                    if (!method14315(var12)) {
                        ...
                        if (var12.field1842 || var15 < var17 && var16 < var18) {
                            ...
                            boolean var22 = var12.clickmask && var12.type == 5 && var12.field1794 == 0 && var12.field1906 < 0 && var12.invobject == -1 && var12.field1737 == -1 && !var12.field1799 && var12.field1783 == 0;
                            boolean var23 = false;
                            if (mouseX >= var15 && mouseY >= var16 && mouseX < var17 && mouseY < var18) {
                                if (var22) {
                                    Graphic var24 = var12.method3124(toolkit);
                            ...
                            if (var30 != null && var30.method15181() == 0 && var30.getX() >= var15 && var30.getY() >= var16 && var30.getX() < var17 && var30.getY() < var18) {
                                if (var22) {
                                    Graphic var31 = var12.method3124(toolkit);
                            ...
                            if (var12.hashook || var12.clientcode != 0) {
                                ...
                                if (var12.clientcode != 0) {
                                    if (Component.field1847 == var12.clientcode || Component.field1742 == var12.clientcode) {
                                        ...
                                        if (var66.getSkybox() != null && !asyncRebuild.processingRequest()) {
                                            var66.getSkybox().method6366(toolkit, var12.renderheight, options.skyDetail.getValue());
                                        }

                                        if (Component.field1847 == var12.clientcode) {
                                            if (!MiniMenu.open && mouseX >= var15 && mouseY >= var16 && mouseX < var17 && mouseY < var18) {
                                                MiniMenu.method4866(toolkit, mouseX, mouseY);
                                        ...
                                        int var72 = 0;
                                        while (true) {
                                            if (var72 >= npcSlotCount) {
                                                continue label998;
                                            }
                                            int var73 = npcSlots[var72];
                                            ObjectNode var74 = (ObjectNode) npcEntities.get((long) var73);
                                            if (var74 != null) {
                                    ...
                                    if (Component.MINIMAP == var12.clientcode) {
                                        Graphic var44 = var12.method3124(toolkit);
                                ...
                                if (var12.field1880 != null && varcTransmitNum > var12.field1869) {
                                    if (var12.field1843 == null || varcTransmitNum - var12.field1869 > 32) {
                                        ...
                                        label835:
                                        for (int var83 = var12.field1869; var83 < varcTransmitNum; var83++) {
                                            int var84 = varcTransmitted[var83 & 0x1F];
                                    ...
                                    var12.field1869 = varcTransmitNum;
                                }
                                if (var12.field1882 != null && varcstrTransmitNum > var12.field1924) {
                                    if (var12.field1883 == null || varcstrTransmitNum - var12.field1924 > 32) {
                                        ...
                                        label811:
                                        for (int var88 = var12.field1924; var88 < varcstrTransmitNum; var88++) {
                                            int var89 = varcstrTransmitted[var88 & 0x1F];
                                    ...
                                    var12.field1924 = varcstrTransmitNum;
                                }
                                if (var12.field1874 != null && varpTransmitNum > var12.field1920) {
                                    if (var12.field1875 == null || varpTransmitNum - var12.field1920 > 32) {
                                        ...
                                        label787:
                                        for (int var93 = var12.field1920; var93 < varpTransmitNum; var93++) {
                                            int var94 = varpTransmitted[var93 & 0x1F];
                                    ...
                                    var12.field1920 = varpTransmitNum;
                                }
                                ...
                                if (var12.field1891 != null) {
                                    for (int var120 = 0; var120 < field8950; var120++) {
                                        ...
                                        var121.keyHook = field8951[var120].method7286();
                            ...
                            if (var12.type == 5 && var12.field1906 != -1) {
                                var12.method3181(Statics.field4678, Statics.field6360).method6366(toolkit, var12.renderheight, options.skyDetail.getValue());
                            }
        ...
        for (int var2 = 0; var2 < arg0.length; var2++) {
            ...
            if (var3 != null) {
                if (var3.type == 0) {
                    ...
                    SubInterface var4 = (SubInterface) field9075.get((long) var3.id);
                    if (var4 != null) {
    ...
    public static void requestRedrawComponent(Component arg0) {
        if (field8960 == arg0.field1927) {
            topLevelComponentRedrawRequestedTemp[arg0.field1926] = true;
        }
    }
    ...
    public static final void method6068(int arg0, int[] arg1) {
        ...
        for (int var3 = 0; var3 < var2.length; var3++) {
            ...
            if (var4 != null && var4.modelAnimator != null) {
                var4.modelAnimator.method11785();
            }
        }
    }
            ...
            if (var3 != null && var3.field1886 == arg1 && !method14315(var3)) {
                ...
                if (var3.type == 6 && var3.modelanim != -1) {
                    if (var3.modelAnimator == null) {
                        ...
                        var3.modelAnimator.method11769(var3.modelanim);
                    }
                    if (var3.modelAnimator.method11787(sceneDelta) && var3.modelAnimator.method11784()) {
                        var3.modelAnimator.method11785();
                    }
                }
            }
        }
    ...
    public static final void onVarPlayerChanged(int arg0) {
        ...
        int var2 = localPlayerGameState.field661[arg0];
        if (var1 == 5) {
            field8933 = var2;
        }
        if (var1 == 6) {
    ...
    public static final void ifClose(boolean arg0) {
        ...
        gameConnection.queue(var1);
        for (SubInterface var2 = (SubInterface) field9075.head(); var2 != null; var2 = (SubInterface) field9075.next()) {
            if (!var2.isLinked()) {
                var2 = (SubInterface) field9075.head();
                if (var2 == null) {
                    break;
                }
            }
    ...
    public static final SubInterface method3589(int arg0, SubInterface arg1, int[] arg2, boolean arg3) {
        SubInterface var4 = (SubInterface) field9075.get((long) arg0);
        if (var4 != null) {
    ...
    public static final void closeSubInterface(SubInterface arg0, boolean arg1, boolean arg2) {
        ...
        HashTableIterator var6 = new HashTableIterator(field9075);
    ...
    public static void method11873(Component arg0, int arg1, int arg2) {
        Graphic var3 = arg0.method3124(toolkit);
        if (var3 == null) {
            return;
        }
        toolkit.r(arg1, arg2, arg0.renderwidth + arg1, arg0.renderheight + arg2);
        if (MiniMap.field762 >= 3) {
            toolkit.DA(-16777216, var3.field1730, arg1, arg2);
            return;
        }
        int var4;
        if (Statics.cameraState == 2) {
    ...
    public static int getComponentOpCursor(Component arg0, int arg1) {
        if (!getComponentEvents(arg0).isOpTransmitted(arg1) && arg0.onop == null) {
            return -1;
    ...
    public static void method4602(String arg0, boolean arg1, int arg2, int arg3, String arg4, boolean arg5) {
        ...
        int var11 = 0;
        for (int var12 = 0; var12 < objTypes.field7144; var12++) {
            ObjType var13 = objTypes.get(var12);
        ...
        for (int var17 = 0; var17 < Statics.field1539; var17++) {
            var16[var17] = objTypes.get(var7[var17]).name;
        }
    ...
    public static void method7723(String arg0) {
        ...
        try {
            ...
            BrowserControl.method12166(Statics.field6387, "document.cookie=\"" + var4 + "\"");
        } catch (Throwable var6) {
        }
    }
    ...
    public static void method8095() {
        ...
        try {
            ...
            BrowserControl.method12166(Statics.field6387, "document.cookie=\"" + var2 + "\"");
        } catch (Throwable var4) {
        }
    }
    ...
    public static String method11406() {
        String var0 = "www";
        if (modewhere == ModeWhere.field6366) {
            var0 = "www-wtrc";
        } else if (modewhere == ModeWhere.field6362) {
            var0 = "www-wtqa";
        } else if (modewhere == ModeWhere.field6369) {
            var0 = "www-wtwip";
        } else if (modewhere == ModeWhere.field6364) {
            var0 = "www-wti";
        }
        String var1 = "";
        if (field8947 != null) {
