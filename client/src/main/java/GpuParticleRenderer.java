...
public class GpuParticleRenderer {
    ...
    @ObfuscatedName("hw.o")
    public Particle[][] field2515 = new Particle[1600][64];

    @ObfuscatedName("hw.q")
    public Particle[][] field2512 = new Particle[64][768];

    @ObfuscatedName("hw.p")
    public int field2518 = 0;

    public GpuParticleRenderer(GpuToolkit arg0) {
        this.field2505 = arg0.method13585(new VertexDeclarationElement[]{new VertexDeclarationElement(new VertexDeclarationElementComponent[]{VertexDeclarationElementComponent.field2495, VertexDeclarationElementComponent.field2488, VertexDeclarationElementComponent.field2483}), new VertexDeclarationElement(VertexDeclarationElementComponent.field2480)});
    ...
    public void method4464(int arg0, Particle arg1) {
        if (arg0 >= 1600) {
            return;
        }
