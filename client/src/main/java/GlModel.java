    ...
    public void method294(Matrix4x3 arg0) {
        ...
        if (this.field7908 != null) {
            for (int var3 = 0; var3 < this.field7908.length; var3++) {
                ...
                var5.x1 = (int) (var2.entries[8] * (float) this.field7904[var4.vertexA] + var2.entries[0] * (float) this.field7865[var4.vertexA] + var2.entries[4] * (float) this.field7866[var4.vertexA] + var2.entries[12]);
                var5.y1 = (int) (var2.entries[9] * (float) this.field7904[var4.vertexA] + var2.entries[1] * (float) this.field7865[var4.vertexA] + var2.entries[5] * (float) this.field7866[var4.vertexA] + var2.entries[13]);
                var5.z1 = (int) (var2.entries[10] * (float) this.field7904[var4.vertexA] + var2.entries[2] * (float) this.field7865[var4.vertexA] + var2.entries[6] * (float) this.field7866[var4.vertexA] + var2.entries[14]);
                var5.x2 = (int) (var2.entries[8] * (float) this.field7904[var4.vertexB] + var2.entries[0] * (float) this.field7865[var4.vertexB] + var2.entries[4] * (float) this.field7866[var4.vertexB] + var2.entries[12]);
                var5.y2 = (int) (var2.entries[9] * (float) this.field7904[var4.vertexB] + var2.entries[1] * (float) this.field7865[var4.vertexB] + var2.entries[5] * (float) this.field7866[var4.vertexB] + var2.entries[13]);
                var5.z2 = (int) (var2.entries[10] * (float) this.field7904[var4.vertexB] + var2.entries[2] * (float) this.field7865[var4.vertexB] + var2.entries[6] * (float) this.field7866[var4.vertexB] + var2.entries[14]);
                var5.x3 = (int) (var2.entries[8] * (float) this.field7904[var4.vertexC] + var2.entries[0] * (float) this.field7865[var4.vertexC] + var2.entries[4] * (float) this.field7866[var4.vertexC] + var2.entries[12]);
                var5.y3 = (int) (var2.entries[9] * (float) this.field7904[var4.vertexC] + var2.entries[1] * (float) this.field7865[var4.vertexC] + var2.entries[5] * (float) this.field7866[var4.vertexC] + var2.entries[13]);
                var5.z3 = (int) (var2.entries[10] * (float) this.field7904[var4.vertexC] + var2.entries[2] * (float) this.field7865[var4.vertexC] + var2.entries[6] * (float) this.field7866[var4.vertexC] + var2.entries[14]);
            }
        }
